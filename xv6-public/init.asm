...
main(void)
{
  ...
  a3:	50                   	push   %eax
  a4:	50                   	push   %eax
  a5:	68 68 0b 00 00       	push   $0xb68
  aa:	68 26 08 00 00       	push   $0x826
  af:	e8 c7 02 00 00       	call   37b <exec>
      printf(1, "init: exec sh failed\n");
  b4:	5a                   	pop    %edx
  b5:	59                   	pop    %ecx
  b6:	68 29 08 00 00       	push   $0x829
  bb:	6a 01                	push   $0x1
  ...
  c8:	6a 01                	push   $0x1
  ca:	6a 01                	push   $0x1
  cc:	68 f8 07 00 00       	push   $0x7f8
  d1:	e8 b5 02 00 00       	call   38b <mknod>
    open("console", O_RDWR);
  d6:	58                   	pop    %eax
  d7:	5a                   	pop    %edx
  d8:	6a 02                	push   $0x2
  da:	68 f8 07 00 00       	push   $0x7f8
 ...
 4d9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 549:	ff 24 85 64 08 00 00 	jmp    *0x864(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 657:	90                   	nop
          s = "(null)";
 658:	ba 5b 08 00 00       	mov    $0x85b,%edx
        while(*s != 0){
