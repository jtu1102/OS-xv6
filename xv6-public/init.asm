...
main(void)
{
  ...
  23:	0f 88 9e 00 00 00    	js     c7 <main+0xc7>
    mknod("console", 1, 1);
    open("console", O_RDWR);
  }
  dup(0);  // stdout
  ...
  63:	78 2b                	js     90 <main+0x90>
      printf(1, "init: fork failed\n");
      exit();
    }
    if(pid == 0){
  65:	74 3c                	je     a3 <main+0xa3>
  ...
  7d:	53                   	push   %ebx
  7e:	50                   	push   %eax
  7f:	68 2f 08 00 00       	push   $0x82f
  84:	6a 01                	push   $0x1
  86:	e8 35 04 00 00       	call   4c0 <printf>
  8b:	83 c4 10             	add    $0x10,%esp
  8e:	eb e0                	jmp    70 <main+0x70>
      printf(1, "init: fork failed\n");
  90:	53                   	push   %ebx
  91:	53                   	push   %ebx
  92:	68 03 08 00 00       	push   $0x803
  97:	6a 01                	push   $0x1
  99:	e8 22 04 00 00       	call   4c0 <printf>
      exit();
  9e:	e8 a0 02 00 00       	call   343 <exit>
      exec("sh", argv);
  a3:	50                   	push   %eax
  a4:	50                   	push   %eax
  a5:	68 58 0b 00 00       	push   $0xb58
  aa:	68 16 08 00 00       	push   $0x816
  af:	e8 c7 02 00 00       	call   37b <exec>
      printf(1, "init: exec sh failed\n");
  b4:	5a                   	pop    %edx
  b5:	59                   	pop    %ecx
  b6:	68 19 08 00 00       	push   $0x819
  bb:	6a 01                	push   $0x1
  bd:	e8 fe 03 00 00       	call   4c0 <printf>
      exit();
  c2:	e8 7c 02 00 00       	call   343 <exit>
    mknod("console", 1, 1);
  c7:	50                   	push   %eax
  c8:	6a 01                	push   $0x1
  ca:	6a 01                	push   $0x1
  cc:	68 e8 07 00 00       	push   $0x7e8
  d1:	e8 b5 02 00 00       	call   38b <mknod>
    open("console", O_RDWR);
  d6:	58                   	pop    %eax
  d7:	5a                   	pop    %edx
  d8:	6a 02                	push   $0x2
  da:	68 e8 07 00 00       	push   $0x7e8
  df:	e8 9f 02 00 00       	call   383 <open>
  e4:	83 c4 10             	add    $0x10,%esp
  e7:	e9 3d ff ff ff       	jmp    29 <main+0x29>
  ec:	66 90                	xchg   %ax,%ax
  ee:	66 90                	xchg   %ax,%ax
 ...
 41c:	89 d1                	mov    %edx,%ecx
{
 ...
 449:	0f b6 92 ac 08 00 00 	movzbl 0x8ac(%edx),%edx
 ...
 4c9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 539:	ff 24 85 54 08 00 00 	jmp    *0x854(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 647:	90                   	nop
          s = "(null)";
 648:	ba 4b 08 00 00       	mov    $0x84b,%edx
        while(*s != 0){
