...
801001a1:	68 ee 77 10 80       	push   $0x801077ee
...
801001be:	e8 dd 45 00 00       	call   801047a0 <holdingsleep>
...
801001dc:	68 ff 77 10 80       	push   $0x801077ff
...
801001ff:	e8 9c 45 00 00       	call   801047a0 <holdingsleep>
...
8010020f:	e8 4c 45 00 00       	call   80104760 <releasesleep>

  acquire(&bcache.lock);
80100214:	c7 04 24 20 b5 10 80 	movl   $0x8010b520,(%esp)
8010021b:	e8 a0 47 00 00       	call   801049c0 <acquire>
  b->refcnt--;
...
8010026b:	5d                   	pop    %ebp
  release(&bcache.lock);
8010026c:	e9 ef 46 00 00       	jmp    80104960 <release>
    panic("brelse");
80100271:	83 ec 0c             	sub    $0xc,%esp
80100274:	68 06 78 10 80       	push   $0x80107806
...
801002a0:	e8 1b 47 00 00       	call   801049c0 <acquire>
  while(n > 0){
...
801002cd:	e8 8e 41 00 00       	call   80104460 <sleep>
    while(input.r == input.w){
...
801002f6:	e8 65 46 00 00       	call   80104960 <release>
        ilock(ip);
801002fb:	5a                   	pop    %edx
...
8010034c:	e8 0f 46 00 00       	call   80104960 <release>
  ilock(ip);
80100351:	58                   	pop    %eax
...
801003a2:	68 0d 78 10 80       	push   $0x8010780d
...
801003c8:	e8 43 44 00 00       	call   80104810 <getcallerpcs>
  for(i=0; i<10; i++)
...
801003d5:	83 c3 04             	add    $0x4,%ebx
    cprintf(" %p", pcs[i]);
801003d8:	68 21 78 10 80       	push   $0x80107821
...
8010041a:	e8 51 5d 00 00       	call   80106170 <uartputc>
...
80100505:	e8 66 5c 00 00       	call   80106170 <uartputc>
8010050a:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100511:	e8 5a 5c 00 00       	call   80106170 <uartputc>
80100516:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010051d:	e8 4e 5c 00 00       	call   80106170 <uartputc>
...
80100551:	e8 ca 45 00 00       	call   80104b20 <memmove>
    memset(crt+pos, 0, sizeof(crt[0])*(24*80 - pos));
...
80100566:	e8 15 45 00 00       	call   80104a80 <memset>
  outb(CRTPORT+1, pos);
...
80100579:	68 25 78 10 80       	push   $0x80107825
...
801005ab:	e8 10 44 00 00       	call   801049c0 <acquire>
  for(i = 0; i < n; i++)
...
801005e4:	e8 77 43 00 00       	call   80104960 <release>
  ilock(ip);
801005e9:	58                   	pop    %eax
...
80100636:	0f b6 92 50 78 10 80 	movzbl -0x7fef87b0(%edx),%edx
  }while((x /= base) != 0);
...
801007e8:	e8 d3 41 00 00       	call   801049c0 <acquire>
...
80100837:	90                   	nop
        s = "(null)";
80100838:	bf 38 78 10 80       	mov    $0x80107838,%edi
      for(; *s; s++)
...
8010085b:	e8 00 41 00 00       	call   80104960 <release>
...
80100873:	68 3f 78 10 80       	push   $0x8010783f
...
80100893:	e8 28 41 00 00       	call   801049c0 <acquire>
  while((c = getc()) >= 0){
...
801009d0:	e8 8b 3f 00 00       	call   80104960 <release>
  if(doprocdump) {
...
80100a0e:	e9 ed 3b 00 00       	jmp    80104600 <procdump>
        input.buf[input.e++ % INPUT_BUF] = c;
...
80100a44:	e8 d7 3a 00 00       	call   80104520 <wakeup>
...
80100a66:	68 48 78 10 80       	push   $0x80107848
80100a6b:	68 20 ff 10 80       	push   $0x8010ff20
80100a70:	e8 7b 3d 00 00       	call   801047f0 <initlock>
...
80100cd3:	e8 a8 3f 00 00       	call   80104c80 <strlen>
...
80100ce4:	83 e3 fc             	and    $0xfffffffc,%ebx
    if(copyout(pgdir, sp, argv[argc], strlen(argv[argc]) + 1) < 0)
80100ce7:	e8 94 3f 00 00       	call   80104c80 <strlen>
...
80100cf8:	e8 73 68 00 00       	call   80107570 <copyout>
...
80100d5d:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100d63:	e8 08 68 00 00       	call   80107570 <copyout>
...
80100da1:	e8 9a 3e 00 00       	call   80104c40 <safestrcpy>
  curproc->pgdir = pgdir;
...
80100dec:	68 61 78 10 80       	push   $0x80107861
...
80100e20:	e8 cb 39 00 00       	call   801047f0 <initlock>
}
...
80100e41:	e8 7a 3b 00 00       	call   801049c0 <acquire>
...
80100e71:	e8 ea 3a 00 00       	call   80104960 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100e8a:	e8 d1 3a 00 00       	call   80104960 <release>
}
...
80100eaf:	e8 0c 3b 00 00       	call   801049c0 <acquire>
  if(f->ref < 1)
...
80100ecc:	e8 8f 3a 00 00       	call   80104960 <release>
  return f;
}
...
80100f01:	e8 ba 3a 00 00       	call   801049c0 <acquire>
  if(f->ref < 1)
...
80100f39:	89 45 e0             	mov    %eax,-0x20(%ebp)
  release(&ftable.lock);
80100f3c:	e8 1f 3a 00 00       	call   80104960 <release>
...
80100f6d:	5d                   	pop    %ebp
    release(&ftable.lock);
80100f6e:	e9 ed 39 00 00       	jmp    80104960 <release>
...
80100fbc:	68 7c 78 10 80       	push   $0x8010787c
...
801010a2:	68 86 78 10 80       	push   $0x80107886
...
80101177:	68 8f 78 10 80       	push   $0x8010788f
...
801011b1:	68 95 78 10 80       	push   $0x80107895
...
80101227:	68 9f 78 10 80       	push   $0x8010789f
...
801012e4:	68 b2 78 10 80       	push   $0x801078b2
...
80101325:	e8 56 37 00 00       	call   80104a80 <memset>
  log_write(bp);
...
8010136a:	e8 51 36 00 00       	call   801049c0 <acquire>
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
...
801013d7:	e8 84 35 00 00       	call   80104960 <release>
...
80101402:	89 43 08             	mov    %eax,0x8(%ebx)
      release(&icache.lock);
80101405:	e8 56 35 00 00       	call   80104960 <release>
      return ip;
...
80101438:	68 c8 78 10 80       	push   $0x801078c8
...
80101515:	68 d8 78 10 80       	push   $0x801078d8
...
80101541:	e8 da 35 00 00       	call   80104b20 <memmove>
  brelse(bp);
...
8010156c:	68 eb 78 10 80       	push   $0x801078eb
80101571:	68 60 09 11 80       	push   $0x80110960
80101576:	e8 75 32 00 00       	call   801047f0 <initlock>
  for(i = 0; i < NINODE; i++) {
8010157b:	83 c4 10             	add    $0x10,%esp
8010157e:	66 90                	xchg   %ax,%ax
    initsleeplock(&icache.inode[i].lock, "inode");
80101580:	83 ec 08             	sub    $0x8,%esp
80101583:	68 f2 78 10 80       	push   $0x801078f2
80101588:	53                   	push   %ebx
  for(i = 0; i < NINODE; i++) {
80101589:	81 c3 90 00 00 00    	add    $0x90,%ebx
    initsleeplock(&icache.inode[i].lock, "inode");
8010158f:	e8 2c 31 00 00       	call   801046c0 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
801015bc:	e8 5f 35 00 00       	call   80104b20 <memmove>
  brelse(bp);
...
801015f3:	68 58 79 10 80       	push   $0x80107958
...
8010168e:	e8 ed 33 00 00       	call   80104a80 <memset>
      dip->type = type;
...
801016c3:	68 f8 78 10 80       	push   $0x801078f8
...
8010175f:	e8 5c 32 00 00       	call   801049c0 <acquire>
  ip->ref++;
80101764:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80101768:	c7 04 24 60 09 11 80 	movl   $0x80110960,(%esp)
8010176f:	e8 ec 31 00 00       	call   80104960 <release>
}
...
801017a2:	e8 59 2f 00 00       	call   80104700 <acquiresleep>
  if(ip->valid == 0){
...
8010183d:	68 10 79 10 80       	push   $0x80107910
80101842:	e8 39 eb ff ff       	call   80100380 <panic>
    panic("ilock");
80101847:	83 ec 0c             	sub    $0xc,%esp
8010184a:	68 0a 79 10 80       	push   $0x8010790a
...
80101873:	e8 28 2f 00 00       	call   801047a0 <holdingsleep>
...
8010188e:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
8010188f:	e9 cc 2e 00 00       	jmp    80104760 <releasesleep>
    panic("iunlock");
80101894:	83 ec 0c             	sub    $0xc,%esp
80101897:	68 1f 79 10 80       	push   $0x8010791f
...
801018c0:	e8 3b 2e 00 00       	call   80104700 <acquiresleep>
...
801018da:	e8 81 2e 00 00       	call   80104760 <releasesleep>
  acquire(&icache.lock);
801018df:	c7 04 24 60 09 11 80 	movl   $0x80110960,(%esp)
801018e6:	e8 d5 30 00 00       	call   801049c0 <acquire>
  ip->ref--;
...
801018ff:	5d                   	pop    %ebp
  release(&icache.lock);
80101900:	e9 5b 30 00 00       	jmp    80104960 <release>
80101905:	8d 76 00             	lea    0x0(%esi),%esi
    acquire(&icache.lock);
80101908:	83 ec 0c             	sub    $0xc,%esp
8010190b:	68 60 09 11 80       	push   $0x80110960
80101910:	e8 ab 30 00 00       	call   801049c0 <acquire>
    int r = ip->ref;
80101915:	8b 73 08             	mov    0x8(%ebx),%esi
    release(&icache.lock);
80101918:	c7 04 24 60 09 11 80 	movl   $0x80110960,(%esp)
8010191f:	e8 3c 30 00 00       	call   80104960 <release>
    if(r == 1){
...
80101a23:	e8 78 2d 00 00       	call   801047a0 <holdingsleep>
...
80101a3a:	e8 21 2d 00 00       	call   80104760 <releasesleep>
  iput(ip);
...
80101a53:	68 1f 79 10 80       	push   $0x8010791f
...
80101b37:	e8 e4 2f 00 00       	call   80104b20 <memmove>
    brelse(bp);
...
80101c33:	e8 e8 2e 00 00       	call   80104b20 <memmove>
    log_write(bp);
...
80101cce:	e8 bd 2e 00 00       	call   80104b90 <strncmp>
}
80101cd3:	c9                   	leave  
80101cd4:	c3                   	ret    
...
80101d2d:	e8 5e 2e 00 00       	call   80104b90 <strncmp>
      continue;
...
80101d72:	68 39 79 10 80       	push   $0x80107939
80101d77:	e8 04 e6 ff ff       	call   80100380 <panic>
    panic("dirlookup not DIR");
80101d7c:	83 ec 0c             	sub    $0xc,%esp
80101d7f:	68 27 79 10 80       	push   $0x80107927
...
80101dba:	e8 01 2c 00 00       	call   801049c0 <acquire>
  ip->ref++;
80101dbf:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101dc3:	c7 04 24 60 09 11 80 	movl   $0x80110960,(%esp)
80101dca:	e8 91 2b 00 00       	call   80104960 <release>
...
80101e27:	e8 f4 2c 00 00       	call   80104b20 <memmove>
...
80101e8c:	e8 0f 29 00 00       	call   801047a0 <holdingsleep>
...
80101eae:	e8 ad 28 00 00       	call   80104760 <releasesleep>
  iput(ip);
...
80101edb:	e8 40 2c 00 00       	call   80104b20 <memmove>
    name[len] = 0;
...
80101f2b:	e8 70 28 00 00       	call   801047a0 <holdingsleep>
...
80101f4a:	e8 11 28 00 00       	call   80104760 <releasesleep>
  iput(ip);
...
80101f6d:	e8 2e 28 00 00       	call   801047a0 <holdingsleep>
...
80101f90:	e8 0b 28 00 00       	call   801047a0 <holdingsleep>
...
80101fa7:	e8 b4 27 00 00       	call   80104760 <releasesleep>
}
...
80101fcf:	68 1f 79 10 80       	push   $0x8010791f
...
8010203d:	e8 9e 2b 00 00       	call   80104be0 <strncpy>
...
8010207b:	68 48 79 10 80       	push   $0x80107948
...
8010219b:	68 b4 79 10 80       	push   $0x801079b4
801021a0:	e8 db e1 ff ff       	call   80100380 <panic>
    panic("idestart");
801021a5:	83 ec 0c             	sub    $0xc,%esp
801021a8:	68 ab 79 10 80       	push   $0x801079ab
...
801021c6:	68 c6 79 10 80       	push   $0x801079c6
801021cb:	68 00 26 11 80       	push   $0x80112600
801021d0:	e8 1b 26 00 00       	call   801047f0 <initlock>
...
8010224e:	e8 6d 27 00 00       	call   801049c0 <acquire>
...
801022ad:	e8 6e 22 00 00       	call   80104520 <wakeup>
...
801022cb:	e8 90 26 00 00       	call   80104960 <release>
...
801022ee:	e8 ad 24 00 00       	call   801047a0 <holdingsleep>
...
80102328:	e8 93 26 00 00       	call   801049c0 <acquire>
...
80102369:	e8 f2 20 00 00       	call   80104460 <sleep>
  while((b->flags & (B_VALID|B_DIRTY)) != B_VALID){
...
80102385:	c9                   	leave  
  release(&idelock);
80102386:	e9 d5 25 00 00       	jmp    80104960 <release>
...
801023aa:	68 f5 79 10 80       	push   $0x801079f5
801023af:	e8 cc df ff ff       	call   80100380 <panic>
    panic("iderw: nothing to do");
801023b4:	83 ec 0c             	sub    $0xc,%esp
801023b7:	68 e0 79 10 80       	push   $0x801079e0
801023bc:	e8 bf df ff ff       	call   80100380 <panic>
    panic("iderw: buf not locked");
801023c1:	83 ec 0c             	sub    $0xc,%esp
801023c4:	68 ca 79 10 80       	push   $0x801079ca
...
8010241a:	68 14 7a 10 80       	push   $0x80107a14
...
801024f2:	e8 89 25 00 00       	call   80104a80 <memset>
...
80102528:	e8 93 24 00 00       	call   801049c0 <acquire>
...
80102542:	c9                   	leave  
    release(&kmem.lock);
80102543:	e9 18 24 00 00       	jmp    80104960 <release>
    panic("kfree");
80102548:	83 ec 0c             	sub    $0xc,%esp
8010254b:	68 46 7a 10 80       	push   $0x80107a46
...
801026b3:	e8 08 23 00 00       	call   801049c0 <acquire>
  r = kmem.freelist;
...
801026e1:	e8 7a 22 00 00       	call   80104960 <release>
  return (char*)r;
...
8010272b:	0f b6 91 80 7b 10 80 	movzbl -0x7fef8480(%ecx),%edx
  shift ^= togglecode[data];
80102732:	0f b6 81 80 7a 10 80 	movzbl -0x7fef8580(%ecx),%eax
  shift |= shiftcode[data];
...
80102748:	83 e2 08             	and    $0x8,%edx
  c = charcode[shift & (CTL | SHIFT)][data];
8010274b:	8b 04 85 60 7a 10 80 	mov    -0x7fef85a0(,%eax,4),%eax
...
80102785:	0f 44 c8             	cmove  %eax,%ecx
    shift &= ~(shiftcode[data] | E0ESC);
80102788:	0f b6 81 80 7b 10 80 	movzbl -0x7fef8480(%ecx),%eax
...
80102af7:	e8 d4 1f 00 00       	call   80104ad0 <memcmp>
...
80102c24:	e8 f7 1e 00 00       	call   80104b20 <memmove>
...
80102cca:	68 80 7c 10 80       	push   $0x80107c80
80102ccf:	68 a0 26 11 80       	push   $0x801126a0
80102cd4:	e8 17 1b 00 00       	call   801047f0 <initlock>
  readsb(dev, &sb);
80102cd9:	58                   	pop    %eax
...
80102d6b:	e8 50 1c 00 00       	call   801049c0 <acquire>
...
80102d85:	e8 d6 16 00 00       	call   80104460 <sleep>
...
80102dbc:	e8 9f 1b 00 00       	call   80104960 <release>
      break;
    }
  }
}
...
80102e1c:	e8 3f 1b 00 00       	call   80104960 <release>
}
...
80102e36:	e8 85 1b 00 00       	call   801049c0 <acquire>
    wakeup(&log);
...
80102e49:	00 00 00 
    wakeup(&log);
80102e4c:	e8 cf 16 00 00       	call   80104520 <wakeup>
    release(&log.lock);
80102e51:	c7 04 24 a0 26 11 80 	movl   $0x801126a0,(%esp)
80102e58:	e8 03 1b 00 00       	call   80104960 <release>
...
80102eb4:	e8 67 1c 00 00       	call   80104b20 <memmove>
...
80102f08:	e8 13 16 00 00       	call   80104520 <wakeup>
  release(&log.lock);
80102f0d:	c7 04 24 a0 26 11 80 	movl   $0x801126a0,(%esp)
80102f14:	e8 47 1a 00 00       	call   80104960 <release>
...
80102f27:	68 84 7c 10 80       	push   $0x80107c84
...
80102f76:	e8 45 1a 00 00       	call   801049c0 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102fb4:	c9                   	leave  
  release(&log.lock);
80102fb5:	e9 a6 19 00 00       	jmp    80104960 <release>
...
80102fe1:	68 93 7c 10 80       	push   $0x80107c93
80102fe6:	e8 95 d3 ff ff       	call   80100380 <panic>
    panic("log_write outside of trans");
80102feb:	83 ec 0c             	sub    $0xc,%esp
80102fee:	68 a9 7c 10 80       	push   $0x80107ca9
...
80103018:	68 c4 7c 10 80       	push   $0x80107cc4
...
80103043:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80103046:	e8 45 3e 00 00       	call   80106e90 <switchkvm>
  seginit();
8010304b:	e8 b0 3d 00 00       	call   80106e00 <seginit>
  lapicinit();
...
80103081:	e8 fa 42 00 00       	call   80107380 <kvmalloc>
  mpinit();        // detect other processors
80103086:	e8 85 01 00 00       	call   80103210 <mpinit>
  lapicinit();     // interrupt controller
8010308b:	e8 60 f7 ff ff       	call   801027f0 <lapicinit>
  seginit();       // segment descriptors
80103090:	e8 6b 3d 00 00       	call   80106e00 <seginit>
  picinit();       // disable pic
...
801030a4:	e8 e7 2f 00 00       	call   80106090 <uartinit>
  pinit();         // process table
801030a9:	e8 62 08 00 00       	call   80103910 <pinit>
  tvinit();        // trap vectors
801030ae:	e8 ed 2b 00 00       	call   80105ca0 <tvinit>
  binit();         // buffer cache
...
801030d4:	e8 47 1a 00 00       	call   80104b20 <memmove>
...
801031be:	68 d8 7c 10 80       	push   $0x80107cd8
801031c3:	56                   	push   %esi
801031c4:	e8 07 19 00 00       	call   80104ad0 <memcmp>
...
80103276:	68 dd 7c 10 80       	push   $0x80107cdd
8010327b:	50                   	push   %eax
  conf = (struct mpconf*) P2V((uint) mp->physaddr);
8010327c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
8010327f:	e8 4c 18 00 00       	call   80104ad0 <memcmp>
...
80103393:	68 e2 7c 10 80       	push   $0x80107ce2
...
801033c2:	68 d8 7c 10 80       	push   $0x80107cd8
801033c7:	53                   	push   %ebx
801033c8:	e8 03 17 00 00       	call   80104ad0 <memcmp>
...
801033f8:	68 fc 7c 10 80       	push   $0x80107cfc
...
801034a0:	00 00 00 
  initlock(&p->lock, "pipe");
801034a3:	68 1b 7d 10 80       	push   $0x80107d1b
801034a8:	50                   	push   %eax
801034a9:	e8 42 13 00 00       	call   801047f0 <initlock>
  (*f0)->type = FD_PIPE;
...
8010353f:	e8 7c 14 00 00       	call   801049c0 <acquire>
  if(writable){
...
8010355f:	e8 bc 0f 00 00       	call   80104520 <wakeup>
...
80103583:	5d                   	pop    %ebp
    release(&p->lock);
80103584:	e9 d7 13 00 00       	jmp    80104960 <release>
80103589:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    release(&p->lock);
80103590:	83 ec 0c             	sub    $0xc,%esp
80103593:	53                   	push   %ebx
80103594:	e8 c7 13 00 00       	call   80104960 <release>
    kfree((char*)p);
...
801035c4:	e8 57 0f 00 00       	call   80104520 <wakeup>
...
801035dd:	e8 de 13 00 00       	call   801049c0 <acquire>
  for(i = 0; i < n; i++){
...
80103638:	e8 e3 0e 00 00       	call   80104520 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
8010363d:	58                   	pop    %eax
8010363e:	5a                   	pop    %edx
8010363f:	53                   	push   %ebx
80103640:	56                   	push   %esi
80103641:	e8 1a 0e 00 00       	call   80104460 <sleep>
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
...
8010366c:	e8 ef 12 00 00       	call   80104960 <release>
        return -1;
...
801036ba:	e8 61 0e 00 00       	call   80104520 <wakeup>
  release(&p->lock);
801036bf:	89 1c 24             	mov    %ebx,(%esp)
801036c2:	e8 99 12 00 00       	call   80104960 <release>
  return n;
...
801036e6:	e8 d5 12 00 00       	call   801049c0 <acquire>
...
80103715:	e8 46 0d 00 00       	call   80104460 <sleep>
  while(p->nread == p->nwrite && p->writeopen){  //DOC: pipe-empty
...
80103776:	e8 a5 0d 00 00       	call   80104520 <wakeup>
  release(&p->lock);
8010377b:	89 34 24             	mov    %esi,(%esp)
8010377e:	e8 dd 11 00 00       	call   80104960 <release>
  return i;
...
80103799:	e8 c2 11 00 00       	call   80104960 <release>
      return -1;
...
801037c1:	e8 fa 11 00 00       	call   801049c0 <acquire>
...
801037ec:	68 20 7d 10 80       	push   $0x80107d20
801037f1:	e8 aa ce ff ff       	call   801006a0 <cprintf>
  p->state = EMBRYO;
  p->pid = nextpid++;
801037f6:	a1 04 b0 10 80       	mov    0x8010b004,%eax
  p->state = EMBRYO;
801037fb:	c7 43 0c 01 00 00 00 	movl   $0x1,0xc(%ebx)

  p->lev = 0;
80103802:	c7 43 7c 00 00 00 00 	movl   $0x0,0x7c(%ebx)
  p->pid = nextpid++;
80103809:	8d 50 01             	lea    0x1(%eax),%edx
8010380c:	89 43 10             	mov    %eax,0x10(%ebx)
  p->tq = 0;
8010380f:	c7 83 80 00 00 00 00 	movl   $0x0,0x80(%ebx)
80103816:	00 00 00 
  p->priority = 3;
80103819:	c7 83 84 00 00 00 03 	movl   $0x3,0x84(%ebx)
80103820:	00 00 00 
...
80103831:	e8 1a 3f 00 00       	call   80107750 <enqueue>

  release(&ptable.lock);
80103836:	c7 04 24 60 30 11 80 	movl   $0x80113060,(%esp)
8010383d:	e8 1e 11 00 00       	call   80104960 <release>

  // Allocate kernel stack.
  if((p->kstack = kalloc()) == 0){
80103842:	e8 39 ee ff ff       	call   80102680 <kalloc>
80103847:	83 c4 10             	add    $0x10,%esp
8010384a:	89 43 08             	mov    %eax,0x8(%ebx)
8010384d:	85 c0                	test   %eax,%eax
8010384f:	74 58                	je     801038a9 <allocproc+0xf9>
    return 0;
  }
...
8010385f:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103862:	c7 40 14 87 5c 10 80 	movl   $0x80105c87,0x14(%eax)
  p->context = (struct context*)sp;
...
80103871:	e8 0a 12 00 00       	call   80104a80 <memset>
...
8010389a:	e8 c1 10 00 00       	call   80104960 <release>
}
...
801038cb:	e8 90 10 00 00       	call   80104960 <release>
...
80103913:	83 ec 14             	sub    $0x14,%esp
  cprintf("여기 들어오긴 하니...........????????\n");
80103916:	68 60 7e 10 80       	push   $0x80107e60
8010391b:	e8 80 cd ff ff       	call   801006a0 <cprintf>
  initQueue(&mlfq.l0);
80103920:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103927:	e8 84 3d 00 00       	call   801076b0 <initQueue>
  initQueue(&mlfq.l1);
8010392c:	c7 04 24 30 2e 11 80 	movl   $0x80112e30,(%esp)
80103933:	e8 78 3d 00 00       	call   801076b0 <initQueue>
  initQueue(&mlfq.l2);
80103938:	c7 04 24 40 2f 11 80 	movl   $0x80112f40,(%esp)
8010393f:	e8 6c 3d 00 00       	call   801076b0 <initQueue>
  cprintf("init queue.......????????\n");
80103944:	c7 04 24 30 7d 10 80 	movl   $0x80107d30,(%esp)
8010394b:	e8 50 cd ff ff       	call   801006a0 <cprintf>
  initlock(&ptable.lock, "ptable");
80103950:	58                   	pop    %eax
80103951:	5a                   	pop    %edx
80103952:	68 4b 7d 10 80       	push   $0x80107d4b
80103957:	68 60 30 11 80       	push   $0x80113060
8010395c:	e8 8f 0e 00 00       	call   801047f0 <initlock>
}
...
801039f4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801039f7:	e8 74 0e 00 00       	call   80104870 <pushcli>
  c = mycpu();
801039fc:	e8 6f ff ff ff       	call   80103970 <mycpu>
  p = c->proc;
80103a01:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103a07:	e8 b4 0e 00 00       	call   801048c0 <popcli>
}
...
80103a2c:	89 c3                	mov    %eax,%ebx
  initproc = p;
80103a2e:	a3 94 52 11 80       	mov    %eax,0x80115294
  if((p->pgdir = setupkvm()) == 0)
80103a33:	e8 c8 38 00 00       	call   80107300 <setupkvm>
...
80103a51:	e8 5a 35 00 00       	call   80106fb0 <inituvm>
...
80103a66:	e8 15 10 00 00       	call   80104a80 <memset>
...
80103abf:	68 7b 7d 10 80       	push   $0x80107d7b
80103ac4:	50                   	push   %eax
80103ac5:	e8 76 11 00 00       	call   80104c40 <safestrcpy>
  p->cwd = namei("/");
80103aca:	c7 04 24 84 7d 10 80 	movl   $0x80107d84,(%esp)
80103ad1:	e8 ca e5 ff ff       	call   801020a0 <namei>
80103ad6:	89 43 68             	mov    %eax,0x68(%ebx)
  acquire(&ptable.lock);
80103ad9:	c7 04 24 60 30 11 80 	movl   $0x80113060,(%esp)
80103ae0:	e8 db 0e 00 00       	call   801049c0 <acquire>
  p->state = RUNNABLE;
80103ae5:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
80103aec:	c7 04 24 60 30 11 80 	movl   $0x80113060,(%esp)
80103af3:	e8 68 0e 00 00       	call   80104960 <release>
}
...
80103b03:	68 62 7d 10 80       	push   $0x80107d62
...
80103b15:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103b18:	e8 53 0d 00 00       	call   80104870 <pushcli>
  c = mycpu();
80103b1d:	e8 4e fe ff ff       	call   80103970 <mycpu>
  p = c->proc;
80103b22:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b28:	e8 93 0d 00 00       	call   801048c0 <popcli>
  sz = curproc->sz;
...
80103b3b:	e8 60 33 00 00       	call   80106ea0 <switchuvm>
  return 0;
...
80103b5a:	e8 c1 35 00 00       	call   80107120 <allocuvm>
...
80103b7a:	e8 d1 36 00 00       	call   80107250 <deallocuvm>
...
80103b96:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103b99:	e8 d2 0c 00 00       	call   80104870 <pushcli>
  c = mycpu();
80103b9e:	e8 cd fd ff ff       	call   80103970 <mycpu>
  p = c->proc;
80103ba3:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ba9:	e8 12 0d 00 00       	call   801048c0 <popcli>
  if((np = allocproc()) == 0){
...
80103bc8:	e8 23 38 00 00       	call   801073f0 <copyuvm>
...
80103c41:	e8 fa 0f 00 00       	call   80104c40 <safestrcpy>
  pid = np->pid;
80103c46:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103c49:	c7 04 24 60 30 11 80 	movl   $0x80113060,(%esp)
80103c50:	e8 6b 0d 00 00       	call   801049c0 <acquire>
  np->state = RUNNABLE;
80103c55:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  release(&ptable.lock);
80103c5c:	c7 04 24 60 30 11 80 	movl   $0x80113060,(%esp)
80103c63:	e8 f8 0c 00 00       	call   80104960 <release>
  return pid;
...
80103cb6:	8d 9d d8 fe ff ff    	lea    -0x128(%ebp),%ebx
80103cbc:	81 ec 2c 01 00 00    	sub    $0x12c,%esp
  struct cpu *c = mycpu();
80103cc2:	e8 a9 fc ff ff       	call   80103970 <mycpu>
  c->proc = 0;
...
80103cd6:	89 85 d4 fe ff ff    	mov    %eax,-0x12c(%ebp)
...
80103ce5:	e8 c6 39 00 00       	call   801076b0 <initQueue>
    acquire(&ptable.lock);
80103cea:	c7 04 24 60 30 11 80 	movl   $0x80113060,(%esp)
80103cf1:	e8 ca 0c 00 00       	call   801049c0 <acquire>
...
80103d03:	68 20 2d 11 80       	push   $0x80112d20
80103d08:	e8 e3 39 00 00       	call   801076f0 <isEmpty>
80103d0d:	83 c4 10             	add    $0x10,%esp
80103d10:	85 c0                	test   %eax,%eax
80103d12:	75 4d                	jne    80103d61 <scheduler+0xb1>
      p = dequeue(&mlfq.l0);
80103d14:	83 ec 0c             	sub    $0xc,%esp
80103d17:	68 20 2d 11 80       	push   $0x80112d20
80103d1c:	e8 6f 3a 00 00       	call   80107790 <dequeue>
      if(p->state == RUNNABLE){ // RUNNABLE한 프로세스인 경우 switch
80103d21:	83 c4 10             	add    $0x10,%esp
      p = dequeue(&mlfq.l0);
80103d24:	89 c7                	mov    %eax,%edi
      if(p->state == RUNNABLE){ // RUNNABLE한 프로세스인 경우 switch
80103d26:	8b 40 0c             	mov    0xc(%eax),%eax
80103d29:	83 f8 03             	cmp    $0x3,%eax
80103d2c:	0f 84 ee 00 00 00    	je     80103e20 <scheduler+0x170>
        if(p->state != UNUSED)
80103d32:	85 c0                	test   %eax,%eax
80103d34:	74 ca                	je     80103d00 <scheduler+0x50>
...
80103d3b:	e8 10 3a 00 00       	call   80107750 <enqueue>
80103d40:	83 c4 10             	add    $0x10,%esp
80103d43:	eb bb                	jmp    80103d00 <scheduler+0x50>
80103d45:	8d 76 00             	lea    0x0(%esi),%esi
      enqueue(&mlfq.l0, dequeue(&tmp));
80103d48:	83 ec 0c             	sub    $0xc,%esp
80103d4b:	53                   	push   %ebx
80103d4c:	e8 3f 3a 00 00       	call   80107790 <dequeue>
80103d51:	59                   	pop    %ecx
80103d52:	5f                   	pop    %edi
80103d53:	50                   	push   %eax
80103d54:	68 20 2d 11 80       	push   $0x80112d20
80103d59:	e8 f2 39 00 00       	call   80107750 <enqueue>
...
80103d65:	e8 86 39 00 00       	call   801076f0 <isEmpty>
80103d6a:	83 c4 10             	add    $0x10,%esp
80103d6d:	85 c0                	test   %eax,%eax
80103d6f:	74 d7                	je     80103d48 <scheduler+0x98>
    int l1_size = mlfq.l1.count;
80103d71:	8b 3d 38 2e 11 80    	mov    0x80112e38,%edi
    while(l1_size--){ // 가장 앞에 있는 RUNNABLE한 프로세스 찾기
80103d77:	85 ff                	test   %edi,%edi
80103d79:	75 0a                	jne    80103d85 <scheduler+0xd5>
80103d7b:	eb 3e                	jmp    80103dbb <scheduler+0x10b>
80103d7d:	8d 76 00             	lea    0x0(%esi),%esi
80103d80:	83 ef 01             	sub    $0x1,%edi
80103d83:	74 36                	je     80103dbb <scheduler+0x10b>
      p = dequeue(&mlfq.l1);
80103d85:	83 ec 0c             	sub    $0xc,%esp
80103d88:	68 30 2e 11 80       	push   $0x80112e30
80103d8d:	e8 fe 39 00 00       	call   80107790 <dequeue>
      if(p->state == RUNNABLE){
80103d92:	83 c4 10             	add    $0x10,%esp
80103d95:	8b 50 0c             	mov    0xc(%eax),%edx
80103d98:	83 fa 03             	cmp    $0x3,%edx
80103d9b:	0f 84 77 01 00 00    	je     80103f18 <scheduler+0x268>
      else if(p->state != UNUSED)
80103da1:	85 d2                	test   %edx,%edx
80103da3:	74 db                	je     80103d80 <scheduler+0xd0>
        enqueue(&mlfq.l1, p); // RUNNABLE로 전환될 여지가 남아 있음, L1의 맨 뒤로 보냄
80103da5:	83 ec 08             	sub    $0x8,%esp
80103da8:	50                   	push   %eax
80103da9:	68 30 2e 11 80       	push   $0x80112e30
80103dae:	e8 9d 39 00 00       	call   80107750 <enqueue>
80103db3:	83 c4 10             	add    $0x10,%esp
    while(l1_size--){ // 가장 앞에 있는 RUNNABLE한 프로세스 찾기
80103db6:	83 ef 01             	sub    $0x1,%edi
80103db9:	75 ca                	jne    80103d85 <scheduler+0xd5>
    int priority_min = 4; // max: 3 이므로 처음 초기화를 위해 4로 설정하고 시작함
80103dbb:	b8 04 00 00 00       	mov    $0x4,%eax
80103dc0:	89 b5 d0 fe ff ff    	mov    %esi,-0x130(%ebp)
      p = NULL;
80103dc6:	31 ff                	xor    %edi,%edi
80103dc8:	89 c6                	mov    %eax,%esi
80103dca:	eb 11                	jmp    80103ddd <scheduler+0x12d>
...
80103dd5:	e8 76 39 00 00       	call   80107750 <enqueue>
80103dda:	83 c4 10             	add    $0x10,%esp
      while(!isEmpty(&mlfq.l2)){ // L2의 프로세스 중 우선순위가 높고 L2에 먼저 들어온 프로세스 찾기
80103ddd:	83 ec 0c             	sub    $0xc,%esp
80103de0:	68 40 2f 11 80       	push   $0x80112f40
80103de5:	e8 06 39 00 00       	call   801076f0 <isEmpty>
80103dea:	83 c4 10             	add    $0x10,%esp
80103ded:	85 c0                	test   %eax,%eax
80103def:	0f 85 9b 00 00 00    	jne    80103e90 <scheduler+0x1e0>
        now = dequeue(&mlfq.l2);
80103df5:	83 ec 0c             	sub    $0xc,%esp
80103df8:	68 40 2f 11 80       	push   $0x80112f40
80103dfd:	e8 8e 39 00 00       	call   80107790 <dequeue>
        if(now->state == RUNNABLE && now->priority < priority_min){
80103e02:	83 c4 10             	add    $0x10,%esp
80103e05:	83 78 0c 03          	cmpl   $0x3,0xc(%eax)
80103e09:	75 c5                	jne    80103dd0 <scheduler+0x120>
80103e0b:	8b 90 84 00 00 00    	mov    0x84(%eax),%edx
80103e11:	39 f2                	cmp    %esi,%edx
80103e13:	7d bb                	jge    80103dd0 <scheduler+0x120>
80103e15:	89 d6                	mov    %edx,%esi
80103e17:	89 c7                	mov    %eax,%edi
80103e19:	eb b5                	jmp    80103dd0 <scheduler+0x120>
80103e1b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103e1f:	90                   	nop
        switchuvm(p);
80103e20:	83 ec 0c             	sub    $0xc,%esp
        c->proc = p;
80103e23:	89 be ac 00 00 00    	mov    %edi,0xac(%esi)
        switchuvm(p);
80103e29:	57                   	push   %edi
80103e2a:	e8 71 30 00 00       	call   80106ea0 <switchuvm>
        p->state = RUNNING;
80103e2f:	c7 47 0c 04 00 00 00 	movl   $0x4,0xc(%edi)
        cprintf("[L0] [pid: %d] lets go~\n", p->pid);
80103e36:	58                   	pop    %eax
80103e37:	5a                   	pop    %edx
80103e38:	ff 77 10             	push   0x10(%edi)
80103e3b:	68 86 7d 10 80       	push   $0x80107d86
80103e40:	e8 5b c8 ff ff       	call   801006a0 <cprintf>
        swtch(&(c->scheduler), p->context);
80103e45:	59                   	pop    %ecx
80103e46:	58                   	pop    %eax
80103e47:	ff 77 1c             	push   0x1c(%edi)
80103e4a:	ff b5 d4 fe ff ff    	push   -0x12c(%ebp)
80103e50:	e8 46 0e 00 00       	call   80104c9b <swtch>
        switchkvm();
80103e55:	e8 36 30 00 00       	call   80106e90 <switchkvm>
        if(p->lev == 1) // tq을 다 쓴 프로세스는 l1로 넘겨줌 (이때, state에 대해서는 고려하지 않고, l1에서 처리되도록 함)
80103e5a:	8b 47 7c             	mov    0x7c(%edi),%eax
80103e5d:	83 c4 10             	add    $0x10,%esp
80103e60:	83 f8 01             	cmp    $0x1,%eax
80103e63:	0f 84 27 01 00 00    	je     80103f90 <scheduler+0x2e0>
        else if(p->lev == 0 && p->state != UNUSED) // tq이 남아 있고 아직 종료되지 않은 프로세스의 경우 l0 큐에 남겨두기 위해 임시저장
80103e69:	85 c0                	test   %eax,%eax
80103e6b:	75 0b                	jne    80103e78 <scheduler+0x1c8>
80103e6d:	8b 47 0c             	mov    0xc(%edi),%eax
80103e70:	85 c0                	test   %eax,%eax
80103e72:	0f 85 68 01 00 00    	jne    80103fe0 <scheduler+0x330>
        c->proc = 0;
80103e78:	c7 86 ac 00 00 00 00 	movl   $0x0,0xac(%esi)
80103e7f:	00 00 00 
80103e82:	e9 79 fe ff ff       	jmp    80103d00 <scheduler+0x50>
80103e87:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80103e8e:	66 90                	xchg   %ax,%ax
      if(p){ // RUNNABLE한 프로세스 중 가장 우선순위가 낮은 프로세스를 찾았다면!
80103e90:	8b b5 d0 fe ff ff    	mov    -0x130(%ebp),%esi
80103e96:	85 ff                	test   %edi,%edi
80103e98:	74 4e                	je     80103ee8 <scheduler+0x238>
        switchuvm(p);
80103e9a:	83 ec 0c             	sub    $0xc,%esp
        c->proc = p;
80103e9d:	89 be ac 00 00 00    	mov    %edi,0xac(%esi)
        switchuvm(p);
80103ea3:	57                   	push   %edi
80103ea4:	e8 f7 2f 00 00       	call   80106ea0 <switchuvm>
        cprintf("[L2] [pid: %d, priority: %d] lets go~\n", p->pid, p->priority);
80103ea9:	83 c4 0c             	add    $0xc,%esp
        p->state = RUNNING;
80103eac:	c7 47 0c 04 00 00 00 	movl   $0x4,0xc(%edi)
        cprintf("[L2] [pid: %d, priority: %d] lets go~\n", p->pid, p->priority);
80103eb3:	ff b7 84 00 00 00    	push   0x84(%edi)
80103eb9:	ff 77 10             	push   0x10(%edi)
80103ebc:	68 b8 7e 10 80       	push   $0x80107eb8
80103ec1:	e8 da c7 ff ff       	call   801006a0 <cprintf>
        swtch(&(c->scheduler), p->context);
80103ec6:	59                   	pop    %ecx
80103ec7:	58                   	pop    %eax
80103ec8:	ff 77 1c             	push   0x1c(%edi)
80103ecb:	ff b5 d4 fe ff ff    	push   -0x12c(%ebp)
80103ed1:	e8 c5 0d 00 00       	call   80104c9b <swtch>
        switchkvm();
80103ed6:	e8 b5 2f 00 00       	call   80106e90 <switchkvm>
        c->proc = 0;
80103edb:	83 c4 10             	add    $0x10,%esp
80103ede:	c7 86 ac 00 00 00 00 	movl   $0x0,0xac(%esi)
80103ee5:	00 00 00 
      while(!isEmpty(&tmp)){ // l2 순서 복원하여 다시 넣기, UNUSED된 프로세스는 정리
80103ee8:	83 ec 0c             	sub    $0xc,%esp
80103eeb:	53                   	push   %ebx
80103eec:	e8 ff 37 00 00       	call   801076f0 <isEmpty>
80103ef1:	83 c4 10             	add    $0x10,%esp
80103ef4:	85 c0                	test   %eax,%eax
80103ef6:	0f 84 b4 00 00 00    	je     80103fb0 <scheduler+0x300>
    release(&ptable.lock);
80103efc:	83 ec 0c             	sub    $0xc,%esp
80103eff:	68 60 30 11 80       	push   $0x80113060
80103f04:	e8 57 0a 00 00       	call   80104960 <release>
  for(;;){
80103f09:	83 c4 10             	add    $0x10,%esp
80103f0c:	e9 cf fd ff ff       	jmp    80103ce0 <scheduler+0x30>
80103f11:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        switchuvm(p);
80103f18:	83 ec 0c             	sub    $0xc,%esp
        c->proc = p;
80103f1b:	89 86 ac 00 00 00    	mov    %eax,0xac(%esi)
        switchuvm(p);
80103f21:	50                   	push   %eax
80103f22:	89 85 d0 fe ff ff    	mov    %eax,-0x130(%ebp)
80103f28:	e8 73 2f 00 00       	call   80106ea0 <switchuvm>
        p->state = RUNNING;
80103f2d:	8b 85 d0 fe ff ff    	mov    -0x130(%ebp),%eax
80103f33:	c7 40 0c 04 00 00 00 	movl   $0x4,0xc(%eax)
        cprintf("[L1] [pid: %d] lets go~\n", p->pid);
80103f3a:	59                   	pop    %ecx
80103f3b:	5f                   	pop    %edi
80103f3c:	ff 70 10             	push   0x10(%eax)
80103f3f:	68 9f 7d 10 80       	push   $0x80107d9f
80103f44:	e8 57 c7 ff ff       	call   801006a0 <cprintf>
        swtch(&(c->scheduler), p->context);
80103f49:	58                   	pop    %eax
80103f4a:	8b 85 d0 fe ff ff    	mov    -0x130(%ebp),%eax
80103f50:	5a                   	pop    %edx
80103f51:	ff 70 1c             	push   0x1c(%eax)
80103f54:	ff b5 d4 fe ff ff    	push   -0x12c(%ebp)
80103f5a:	e8 3c 0d 00 00       	call   80104c9b <swtch>
        switchkvm();
80103f5f:	e8 2c 2f 00 00       	call   80106e90 <switchkvm>
        if(p->lev == 2) // tq을 다 쓴 프로세스는 dequeue 하고, l2로 넘겨줌
80103f64:	8b 85 d0 fe ff ff    	mov    -0x130(%ebp),%eax
80103f6a:	83 c4 10             	add    $0x10,%esp
80103f6d:	8b 50 7c             	mov    0x7c(%eax),%edx
80103f70:	83 fa 02             	cmp    $0x2,%edx
80103f73:	0f 84 a7 00 00 00    	je     80104020 <scheduler+0x370>
        else if(p->lev == 1 && p->state != UNUSED) // tq이 남아 있을 경우 l1 큐에 그대로 남겨 둠
80103f79:	83 fa 01             	cmp    $0x1,%edx
80103f7c:	74 7a                	je     80103ff8 <scheduler+0x348>
        c->proc = 0;
80103f7e:	c7 86 ac 00 00 00 00 	movl   $0x0,0xac(%esi)
80103f85:	00 00 00 
    if(!is_l1_have_runnable){
80103f88:	e9 6f ff ff ff       	jmp    80103efc <scheduler+0x24c>
80103f8d:	8d 76 00             	lea    0x0(%esi),%esi
          enqueue(&mlfq.l1, p);
80103f90:	83 ec 08             	sub    $0x8,%esp
80103f93:	57                   	push   %edi
80103f94:	68 30 2e 11 80       	push   $0x80112e30
80103f99:	e8 b2 37 00 00       	call   80107750 <enqueue>
80103f9e:	83 c4 10             	add    $0x10,%esp
80103fa1:	e9 d2 fe ff ff       	jmp    80103e78 <scheduler+0x1c8>
...
80103fb4:	e8 d7 37 00 00       	call   80107790 <dequeue>
        if(now->state != UNUSED)
80103fb9:	83 c4 10             	add    $0x10,%esp
80103fbc:	8b 50 0c             	mov    0xc(%eax),%edx
80103fbf:	85 d2                	test   %edx,%edx
80103fc1:	0f 84 21 ff ff ff    	je     80103ee8 <scheduler+0x238>
          enqueue(&mlfq.l2, now);
80103fc7:	83 ec 08             	sub    $0x8,%esp
80103fca:	50                   	push   %eax
80103fcb:	68 40 2f 11 80       	push   $0x80112f40
80103fd0:	e8 7b 37 00 00       	call   80107750 <enqueue>
80103fd5:	83 c4 10             	add    $0x10,%esp
80103fd8:	e9 0b ff ff ff       	jmp    80103ee8 <scheduler+0x238>
80103fdd:	8d 76 00             	lea    0x0(%esi),%esi
          enqueue(&tmp, p);
80103fe0:	83 ec 08             	sub    $0x8,%esp
80103fe3:	57                   	push   %edi
80103fe4:	53                   	push   %ebx
80103fe5:	e8 66 37 00 00       	call   80107750 <enqueue>
80103fea:	83 c4 10             	add    $0x10,%esp
80103fed:	e9 86 fe ff ff       	jmp    80103e78 <scheduler+0x1c8>
80103ff2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        else if(p->lev == 1 && p->state != UNUSED) // tq이 남아 있을 경우 l1 큐에 그대로 남겨 둠
80103ff8:	8b 50 0c             	mov    0xc(%eax),%edx
80103ffb:	85 d2                	test   %edx,%edx
80103ffd:	0f 84 7b ff ff ff    	je     80103f7e <scheduler+0x2ce>
          enqueue(&mlfq.l1, p);
80104003:	83 ec 08             	sub    $0x8,%esp
80104006:	50                   	push   %eax
80104007:	68 30 2e 11 80       	push   $0x80112e30
8010400c:	e8 3f 37 00 00       	call   80107750 <enqueue>
80104011:	83 c4 10             	add    $0x10,%esp
80104014:	e9 65 ff ff ff       	jmp    80103f7e <scheduler+0x2ce>
80104019:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
          enqueue(&mlfq.l2, p);
80104020:	83 ec 08             	sub    $0x8,%esp
80104023:	50                   	push   %eax
80104024:	68 40 2f 11 80       	push   $0x80112f40
80104029:	e8 22 37 00 00       	call   80107750 <enqueue>
8010402e:	83 c4 10             	add    $0x10,%esp
80104031:	e9 48 ff ff ff       	jmp    80103f7e <scheduler+0x2ce>
...
80104044:	53                   	push   %ebx
  pushcli();
80104045:	e8 26 08 00 00       	call   80104870 <pushcli>
  c = mycpu();
8010404a:	e8 21 f9 ff ff       	call   80103970 <mycpu>
  p = c->proc;
8010404f:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104055:	e8 66 08 00 00       	call   801048c0 <popcli>
  if(!holding(&ptable.lock))
8010405a:	83 ec 0c             	sub    $0xc,%esp
8010405d:	68 60 30 11 80       	push   $0x80113060
80104062:	e8 b9 08 00 00       	call   80104920 <holding>
80104067:	83 c4 10             	add    $0x10,%esp
8010406a:	85 c0                	test   %eax,%eax
8010406c:	74 4f                	je     801040bd <sched+0x7d>
  if(mycpu()->ncli != 1)
8010406e:	e8 fd f8 ff ff       	call   80103970 <mycpu>
...
80104106:	83 ec 0c             	sub    $0xc,%esp
  struct proc *curproc = myproc();
80104109:	e8 e2 f8 ff ff       	call   801039f0 <myproc>
  if(curproc == initproc)
...
8010416a:	e8 51 08 00 00       	call   801049c0 <acquire>
...
80104217:	68 05 7e 10 80       	push   $0x80107e05
8010421c:	e8 5f c1 ff ff       	call   80100380 <panic>
    panic("init exiting");
80104221:	83 ec 0c             	sub    $0xc,%esp
80104224:	68 f8 7d 10 80       	push   $0x80107df8
...
80104234:	53                   	push   %ebx
  pushcli();
80104235:	e8 36 06 00 00       	call   80104870 <pushcli>
  c = mycpu();
8010423a:	e8 31 f7 ff ff       	call   80103970 <mycpu>
  p = c->proc;
8010423f:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80104245:	e8 76 06 00 00       	call   801048c0 <popcli>
  acquire(&ptable.lock);
8010424a:	83 ec 0c             	sub    $0xc,%esp
8010424d:	68 60 30 11 80       	push   $0x80113060
80104252:	e8 69 07 00 00       	call   801049c0 <acquire>
...
801042a1:	0f 85 8f 00 00 00    	jne    80104336 <wait+0x106>
  pushcli();
801042a7:	e8 c4 05 00 00       	call   80104870 <pushcli>
  c = mycpu();
801042ac:	e8 bf f6 ff ff       	call   80103970 <mycpu>
  p = c->proc;
801042b1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801042b7:	e8 04 06 00 00       	call   801048c0 <popcli>
  if(p == 0)
...
801042f9:	e8 82 2f 00 00       	call   80107280 <freevm>
        p->pid = 0;
...
80104325:	e8 36 06 00 00       	call   80104960 <release>
        return pid;
...
8010436c:	e8 4f 06 00 00       	call   801049c0 <acquire>
  pushcli();
80104371:	e8 fa 04 00 00       	call   80104870 <pushcli>
  c = mycpu();
80104376:	e8 f5 f5 ff ff       	call   80103970 <mycpu>
  p = c->proc;
8010437b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104381:	e8 3a 05 00 00       	call   801048c0 <popcli>
  myproc()->state = RUNNABLE; //실행 중인 프로세스를 RUNNABLE 상태로 전환시킴
80104386:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  pushcli();
8010438d:	e8 de 04 00 00       	call   80104870 <pushcli>
  c = mycpu();
80104392:	e8 d9 f5 ff ff       	call   80103970 <mycpu>
  p = c->proc;
80104397:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010439d:	e8 1e 05 00 00       	call   801048c0 <popcli>
  if(myproc()->lev != 2)
801043a2:	83 c4 10             	add    $0x10,%esp
801043a5:	83 7b 7c 02          	cmpl   $0x2,0x7c(%ebx)
801043a9:	74 35                	je     801043e0 <yield+0x80>
  pushcli();
801043ab:	e8 c0 04 00 00       	call   80104870 <pushcli>
  c = mycpu();
801043b0:	e8 bb f5 ff ff       	call   80103970 <mycpu>
  p = c->proc;
801043b5:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801043bb:	e8 00 05 00 00       	call   801048c0 <popcli>
    myproc()->lev++;
801043c0:	83 43 7c 01          	addl   $0x1,0x7c(%ebx)
  sched(); // switch to scheduler
801043c4:	e8 77 fc ff ff       	call   80104040 <sched>
  release(&ptable.lock);
801043c9:	83 ec 0c             	sub    $0xc,%esp
801043cc:	68 60 30 11 80       	push   $0x80113060
801043d1:	e8 8a 05 00 00       	call   80104960 <release>
}
...
801043de:	66 90                	xchg   %ax,%ax
  pushcli();
801043e0:	e8 8b 04 00 00       	call   80104870 <pushcli>
  c = mycpu();
801043e5:	e8 86 f5 ff ff       	call   80103970 <mycpu>
  p = c->proc;
801043ea:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801043f0:	e8 cb 04 00 00       	call   801048c0 <popcli>
  else if(myproc()->lev == 2){ // L2의 큐가 tq을 모두 소비한 경우
801043f5:	83 7b 7c 02          	cmpl   $0x2,0x7c(%ebx)
801043f9:	75 c9                	jne    801043c4 <yield+0x64>
  pushcli();
801043fb:	e8 70 04 00 00       	call   80104870 <pushcli>
  c = mycpu();
80104400:	e8 6b f5 ff ff       	call   80103970 <mycpu>
  p = c->proc;
80104405:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010440b:	e8 b0 04 00 00       	call   801048c0 <popcli>
    if(myproc()->priority > 0)
80104410:	8b 83 84 00 00 00    	mov    0x84(%ebx),%eax
80104416:	85 c0                	test   %eax,%eax
80104418:	7f 26                	jg     80104440 <yield+0xe0>
  pushcli();
8010441a:	e8 51 04 00 00       	call   80104870 <pushcli>
  c = mycpu();
8010441f:	e8 4c f5 ff ff       	call   80103970 <mycpu>
  p = c->proc;
80104424:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010442a:	e8 91 04 00 00       	call   801048c0 <popcli>
    myproc()->tq = 0;
8010442f:	c7 83 80 00 00 00 00 	movl   $0x0,0x80(%ebx)
80104436:	00 00 00 
80104439:	eb 89                	jmp    801043c4 <yield+0x64>
8010443b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
8010443f:	90                   	nop
  pushcli();
80104440:	e8 2b 04 00 00       	call   80104870 <pushcli>
  c = mycpu();
80104445:	e8 26 f5 ff ff       	call   80103970 <mycpu>
  p = c->proc;
8010444a:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104450:	e8 6b 04 00 00       	call   801048c0 <popcli>
      myproc()->priority--;
80104455:	83 ab 84 00 00 00 01 	subl   $0x1,0x84(%ebx)
8010445c:	eb bc                	jmp    8010441a <yield+0xba>
...
8010446c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
8010446f:	e8 fc 03 00 00       	call   80104870 <pushcli>
  c = mycpu();
80104474:	e8 f7 f4 ff ff       	call   80103970 <mycpu>
  p = c->proc;
80104479:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010447f:	e8 3c 04 00 00       	call   801048c0 <popcli>
  if(p == 0)
...
80104490:	81 fe 60 30 11 80    	cmp    $0x80113060,%esi
80104496:	74 50                	je     801044e8 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
80104498:	83 ec 0c             	sub    $0xc,%esp
8010449b:	68 60 30 11 80       	push   $0x80113060
801044a0:	e8 1b 05 00 00       	call   801049c0 <acquire>
    release(lk);
801044a5:	89 34 24             	mov    %esi,(%esp)
801044a8:	e8 b3 04 00 00       	call   80104960 <release>
  p->chan = chan;
801044ad:	89 7b 20             	mov    %edi,0x20(%ebx)
  p->state = SLEEPING;
801044b0:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
801044b7:	e8 84 fb ff ff       	call   80104040 <sched>
  p->chan = 0;
801044bc:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
    release(&ptable.lock);
801044c3:	c7 04 24 60 30 11 80 	movl   $0x80113060,(%esp)
801044ca:	e8 91 04 00 00       	call   80104960 <release>
    acquire(lk);
...
801044db:	5d                   	pop    %ebp
    acquire(lk);
801044dc:	e9 df 04 00 00       	jmp    801049c0 <acquire>
...
801044eb:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
801044f2:	e8 49 fb ff ff       	call   80104040 <sched>
  p->chan = 0;
...
80104509:	68 17 7e 10 80       	push   $0x80107e17
8010450e:	e8 6d be ff ff       	call   80100380 <panic>
    panic("sleep");
80104513:	83 ec 0c             	sub    $0xc,%esp
80104516:	68 11 7e 10 80       	push   $0x80107e11
8010451b:	e8 60 be ff ff       	call   80100380 <panic>
...
80104527:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ptable.lock);
8010452a:	68 60 30 11 80       	push   $0x80113060
8010452f:	e8 8c 04 00 00       	call   801049c0 <acquire>
80104534:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104537:	b8 94 30 11 80       	mov    $0x80113094,%eax
8010453c:	eb 0e                	jmp    8010454c <wakeup+0x2c>
8010453e:	66 90                	xchg   %ax,%ax
80104540:	05 88 00 00 00       	add    $0x88,%eax
80104545:	3d 94 52 11 80       	cmp    $0x80115294,%eax
8010454a:	74 1e                	je     8010456a <wakeup+0x4a>
    if(p->state == SLEEPING && p->chan == chan)
8010454c:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
80104550:	75 ee                	jne    80104540 <wakeup+0x20>
80104552:	3b 58 20             	cmp    0x20(%eax),%ebx
80104555:	75 e9                	jne    80104540 <wakeup+0x20>
      p->state = RUNNABLE;
80104557:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010455e:	05 88 00 00 00       	add    $0x88,%eax
80104563:	3d 94 52 11 80       	cmp    $0x80115294,%eax
80104568:	75 e2                	jne    8010454c <wakeup+0x2c>
  wakeup1(chan);
  release(&ptable.lock);
8010456a:	c7 45 08 60 30 11 80 	movl   $0x80113060,0x8(%ebp)
}
80104571:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104574:	c9                   	leave  
  release(&ptable.lock);
80104575:	e9 e6 03 00 00       	jmp    80104960 <release>
...
80104587:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&ptable.lock);
8010458a:	68 60 30 11 80       	push   $0x80113060
8010458f:	e8 2c 04 00 00       	call   801049c0 <acquire>
80104594:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104597:	b8 94 30 11 80       	mov    $0x80113094,%eax
8010459c:	eb 0e                	jmp    801045ac <kill+0x2c>
8010459e:	66 90                	xchg   %ax,%ax
801045a0:	05 88 00 00 00       	add    $0x88,%eax
801045a5:	3d 94 52 11 80       	cmp    $0x80115294,%eax
801045aa:	74 34                	je     801045e0 <kill+0x60>
    if(p->pid == pid){
801045ac:	39 58 10             	cmp    %ebx,0x10(%eax)
801045af:	75 ef                	jne    801045a0 <kill+0x20>
      p->killed = 1;
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
801045b1:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
      p->killed = 1;
801045b5:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
      if(p->state == SLEEPING)
801045bc:	75 07                	jne    801045c5 <kill+0x45>
        p->state = RUNNABLE;
801045be:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
      release(&ptable.lock);
801045c5:	83 ec 0c             	sub    $0xc,%esp
801045c8:	68 60 30 11 80       	push   $0x80113060
801045cd:	e8 8e 03 00 00       	call   80104960 <release>
...
801045e3:	68 60 30 11 80       	push   $0x80113060
801045e8:	e8 73 03 00 00       	call   80104960 <release>
}
...
80104605:	8d 75 e8             	lea    -0x18(%ebp),%esi
80104608:	53                   	push   %ebx
80104609:	bb 00 31 11 80       	mov    $0x80113100,%ebx
...
8010461b:	68 40 80 10 80       	push   $0x80108040
80104620:	e8 7b c0 ff ff       	call   801006a0 <cprintf>
80104625:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104628:	81 c3 88 00 00 00    	add    $0x88,%ebx
8010462e:	81 fb 00 53 11 80    	cmp    $0x80115300,%ebx
80104634:	0f 84 7e 00 00 00    	je     801046b8 <procdump+0xb8>
    if(p->state == UNUSED)
8010463a:	8b 43 a0             	mov    -0x60(%ebx),%eax
8010463d:	85 c0                	test   %eax,%eax
8010463f:	74 e7                	je     80104628 <procdump+0x28>
      state = "???";
80104641:	ba 28 7e 10 80       	mov    $0x80107e28,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104646:	83 f8 05             	cmp    $0x5,%eax
80104649:	77 11                	ja     8010465c <procdump+0x5c>
8010464b:	8b 14 85 e0 7e 10 80 	mov    -0x7fef8120(,%eax,4),%edx
      state = "???";
80104652:	b8 28 7e 10 80       	mov    $0x80107e28,%eax
80104657:	85 d2                	test   %edx,%edx
80104659:	0f 44 d0             	cmove  %eax,%edx
    cprintf("%d %s %s", p->pid, state, p->name);
8010465c:	53                   	push   %ebx
8010465d:	52                   	push   %edx
8010465e:	ff 73 a4             	push   -0x5c(%ebx)
80104661:	68 2c 7e 10 80       	push   $0x80107e2c
80104666:	e8 35 c0 ff ff       	call   801006a0 <cprintf>
    if(p->state == SLEEPING){
8010466b:	83 c4 10             	add    $0x10,%esp
8010466e:	83 7b a0 02          	cmpl   $0x2,-0x60(%ebx)
80104672:	75 a4                	jne    80104618 <procdump+0x18>
      getcallerpcs((uint*)p->context->ebp+2, pc);
80104674:	83 ec 08             	sub    $0x8,%esp
80104677:	8d 45 c0             	lea    -0x40(%ebp),%eax
8010467a:	8d 7d c0             	lea    -0x40(%ebp),%edi
8010467d:	50                   	push   %eax
8010467e:	8b 43 b0             	mov    -0x50(%ebx),%eax
80104681:	8b 40 0c             	mov    0xc(%eax),%eax
80104684:	83 c0 08             	add    $0x8,%eax
80104687:	50                   	push   %eax
80104688:	e8 83 01 00 00       	call   80104810 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
8010468d:	83 c4 10             	add    $0x10,%esp
80104690:	8b 17                	mov    (%edi),%edx
80104692:	85 d2                	test   %edx,%edx
80104694:	74 82                	je     80104618 <procdump+0x18>
        cprintf(" %p", pc[i]);
80104696:	83 ec 08             	sub    $0x8,%esp
      for(i=0; i<10 && pc[i] != 0; i++)
80104699:	83 c7 04             	add    $0x4,%edi
        cprintf(" %p", pc[i]);
8010469c:	52                   	push   %edx
8010469d:	68 21 78 10 80       	push   $0x80107821
801046a2:	e8 f9 bf ff ff       	call   801006a0 <cprintf>
      for(i=0; i<10 && pc[i] != 0; i++)
801046a7:	83 c4 10             	add    $0x10,%esp
801046aa:	39 fe                	cmp    %edi,%esi
801046ac:	75 e2                	jne    80104690 <procdump+0x90>
801046ae:	e9 65 ff ff ff       	jmp    80104618 <procdump+0x18>
...
801046ca:	68 f8 7e 10 80       	push   $0x80107ef8
...
8010470f:	e8 ac 02 00 00       	call   801049c0 <acquire>
  while (lk->locked) {
...
80104725:	e8 36 fd ff ff       	call   80104460 <sleep>
  while (lk->locked) {
...
80104733:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104739:	e8 b2 f2 ff ff       	call   801039f0 <myproc>
...
8010474c:	5d                   	pop    %ebp
  release(&lk->lk);
8010474d:	e9 0e 02 00 00       	jmp    80104960 <release>
...
80104765:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&lk->lk);
80104768:	8d 73 04             	lea    0x4(%ebx),%esi
8010476b:	83 ec 0c             	sub    $0xc,%esp
8010476e:	56                   	push   %esi
8010476f:	e8 4c 02 00 00       	call   801049c0 <acquire>
  lk->locked = 0;
...
80104784:	e8 97 fd ff ff       	call   80104520 <wakeup>
  release(&lk->lk);
...
80104794:	5d                   	pop    %ebp
  release(&lk->lk);
80104795:	e9 c6 01 00 00       	jmp    80104960 <release>
...
801047b2:	e8 09 02 00 00       	call   801049c0 <acquire>
  r = lk->locked && (lk->pid == myproc()->pid);
801047b7:	8b 03                	mov    (%ebx),%eax
801047b9:	83 c4 10             	add    $0x10,%esp
801047bc:	85 c0                	test   %eax,%eax
801047be:	75 18                	jne    801047d8 <holdingsleep+0x38>
  release(&lk->lk);
801047c0:	83 ec 0c             	sub    $0xc,%esp
801047c3:	56                   	push   %esi
801047c4:	e8 97 01 00 00       	call   80104960 <release>
  return r;
}
801047c9:	8d 65 f4             	lea    -0xc(%ebp),%esp
801047cc:	89 f8                	mov    %edi,%eax
801047ce:	5b                   	pop    %ebx
801047cf:	5e                   	pop    %esi
801047d0:	5f                   	pop    %edi
801047d1:	5d                   	pop    %ebp
...
801047d7:	90                   	nop
  r = lk->locked && (lk->pid == myproc()->pid);
801047d8:	8b 5b 3c             	mov    0x3c(%ebx),%ebx
801047db:	e8 10 f2 ff ff       	call   801039f0 <myproc>
801047e0:	39 58 10             	cmp    %ebx,0x10(%eax)
801047e3:	0f 94 c0             	sete   %al
801047e6:	0f b6 c0             	movzbl %al,%eax
801047e9:	89 c7                	mov    %eax,%edi
801047eb:	eb d3                	jmp    801047c0 <holdingsleep+0x20>
...
8010484b:	8d 51 28             	lea    0x28(%ecx),%edx
...
80104879:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
8010487a:	e8 f1 f0 ff ff       	call   80103970 <mycpu>
8010487f:	8b 80 a4 00 00 00    	mov    0xa4(%eax),%eax
80104885:	85 c0                	test   %eax,%eax
80104887:	74 17                	je     801048a0 <pushcli+0x30>
    mycpu()->intena = eflags & FL_IF;
  mycpu()->ncli += 1;
80104889:	e8 e2 f0 ff ff       	call   80103970 <mycpu>
8010488e:	83 80 a4 00 00 00 01 	addl   $0x1,0xa4(%eax)
}
...
8010489a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    mycpu()->intena = eflags & FL_IF;
801048a0:	e8 cb f0 ff ff       	call   80103970 <mycpu>
801048a5:	81 e3 00 02 00 00    	and    $0x200,%ebx
801048ab:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
801048b1:	eb d6                	jmp    80104889 <pushcli+0x19>
...
801048ec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
801048f0:	e8 7b f0 ff ff       	call   80103970 <mycpu>
...
80104905:	68 03 7f 10 80       	push   $0x80107f03
8010490a:	e8 71 ba ff ff       	call   80100380 <panic>
    panic("popcli");
8010490f:	83 ec 0c             	sub    $0xc,%esp
80104912:	68 1a 7f 10 80       	push   $0x80107f1a
80104917:	e8 64 ba ff ff       	call   80100380 <panic>
...
80104933:	75 0b                	jne    80104940 <holding+0x20>
  popcli();
80104935:	e8 86 ff ff ff       	call   801048c0 <popcli>
}
...
8010493f:	c3                   	ret    
  r = lock->locked && lock->cpu == mycpu();
80104940:	8b 5e 08             	mov    0x8(%esi),%ebx
80104943:	e8 28 f0 ff ff       	call   80103970 <mycpu>
80104948:	39 c3                	cmp    %eax,%ebx
8010494a:	0f 94 c3             	sete   %bl
  popcli();
8010494d:	e8 6e ff ff ff       	call   801048c0 <popcli>
  r = lock->locked && lock->cpu == mycpu();
80104952:	0f b6 db             	movzbl %bl,%ebx
}
80104955:	89 d8                	mov    %ebx,%eax
80104957:	5b                   	pop    %ebx
80104958:	5e                   	pop    %esi
80104959:	5d                   	pop    %ebp
8010495a:	c3                   	ret    
...
80104965:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pushcli();
80104968:	e8 03 ff ff ff       	call   80104870 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
8010496d:	8b 03                	mov    (%ebx),%eax
8010496f:	85 c0                	test   %eax,%eax
80104971:	75 15                	jne    80104988 <release+0x28>
  popcli();
80104973:	e8 48 ff ff ff       	call   801048c0 <popcli>
    panic("release");
80104978:	83 ec 0c             	sub    $0xc,%esp
8010497b:	68 21 7f 10 80       	push   $0x80107f21
80104980:	e8 fb b9 ff ff       	call   80100380 <panic>
80104985:	8d 76 00             	lea    0x0(%esi),%esi
  r = lock->locked && lock->cpu == mycpu();
80104988:	8b 73 08             	mov    0x8(%ebx),%esi
8010498b:	e8 e0 ef ff ff       	call   80103970 <mycpu>
80104990:	39 c6                	cmp    %eax,%esi
80104992:	75 df                	jne    80104973 <release+0x13>
  popcli();
80104994:	e8 27 ff ff ff       	call   801048c0 <popcli>
  lk->pcs[0] = 0;
80104999:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
  lk->cpu = 0;
801049a0:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
  __sync_synchronize();
801049a7:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  asm volatile("movl $0, %0" : "+m" (lk->locked) : );
801049ac:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
}
...
801049b7:	5d                   	pop    %ebp
  popcli();
801049b8:	e9 03 ff ff ff       	jmp    801048c0 <popcli>
...
801049c7:	e8 a4 fe ff ff       	call   80104870 <pushcli>
  if(holding(lk)) // 이미 lock 되어 있는지 확인
801049cc:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pushcli();
801049cf:	e8 9c fe ff ff       	call   80104870 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
801049d4:	8b 03                	mov    (%ebx),%eax
801049d6:	85 c0                	test   %eax,%eax
801049d8:	75 7e                	jne    80104a58 <acquire+0x98>
  popcli();
801049da:	e8 e1 fe ff ff       	call   801048c0 <popcli>
  asm volatile("lock; xchgl %0, %1" :
801049df:	b9 01 00 00 00       	mov    $0x1,%ecx
801049e4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  while(xchg(&lk->locked, 1) != 0)
801049e8:	8b 55 08             	mov    0x8(%ebp),%edx
801049eb:	89 c8                	mov    %ecx,%eax
801049ed:	f0 87 02             	lock xchg %eax,(%edx)
801049f0:	85 c0                	test   %eax,%eax
801049f2:	75 f4                	jne    801049e8 <acquire+0x28>
  __sync_synchronize();
801049f4:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  lk->cpu = mycpu();
801049f9:	8b 5d 08             	mov    0x8(%ebp),%ebx
801049fc:	e8 6f ef ff ff       	call   80103970 <mycpu>
  getcallerpcs(&lk, lk->pcs);
80104a01:	8b 4d 08             	mov    0x8(%ebp),%ecx
  ebp = (uint*)v - 2;
80104a04:	89 ea                	mov    %ebp,%edx
  lk->cpu = mycpu();
80104a06:	89 43 08             	mov    %eax,0x8(%ebx)
  for(i = 0; i < 10; i++){
...
80104a1c:	77 1a                	ja     80104a38 <acquire+0x78>
    pcs[i] = ebp[1];     // saved %eip
80104a1e:	8b 5a 04             	mov    0x4(%edx),%ebx
80104a21:	89 5c 81 0c          	mov    %ebx,0xc(%ecx,%eax,4)
  for(i = 0; i < 10; i++){
80104a25:	83 c0 01             	add    $0x1,%eax
    ebp = (uint*)ebp[0]; // saved %ebp
80104a28:	8b 12                	mov    (%edx),%edx
  for(i = 0; i < 10; i++){
80104a2a:	83 f8 0a             	cmp    $0xa,%eax
80104a2d:	75 e1                	jne    80104a10 <acquire+0x50>
}
...
80104a34:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for(; i < 10; i++)
80104a38:	8d 44 81 0c          	lea    0xc(%ecx,%eax,4),%eax
80104a3c:	8d 51 34             	lea    0x34(%ecx),%edx
80104a3f:	90                   	nop
    pcs[i] = 0;
...
80104a52:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  r = lock->locked && lock->cpu == mycpu();
80104a58:	8b 5b 08             	mov    0x8(%ebx),%ebx
80104a5b:	e8 10 ef ff ff       	call   80103970 <mycpu>
80104a60:	39 c3                	cmp    %eax,%ebx
80104a62:	0f 85 72 ff ff ff    	jne    801049da <acquire+0x1a>
  popcli();
80104a68:	e8 53 fe ff ff       	call   801048c0 <popcli>
    panic("acquire");
80104a6d:	83 ec 0c             	sub    $0xc,%esp
80104a70:	68 29 7f 10 80       	push   $0x80107f29
...
80104a90:	09 cf                	or     %ecx,%edi
80104a92:	83 e7 03             	and    $0x3,%edi
80104a95:	75 29                	jne    80104ac0 <memset+0x40>
    c &= 0xFF;
80104a97:	0f b6 f8             	movzbl %al,%edi
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
80104a9a:	c1 e0 18             	shl    $0x18,%eax
80104a9d:	89 fb                	mov    %edi,%ebx
80104a9f:	c1 e9 02             	shr    $0x2,%ecx
80104aa2:	c1 e3 10             	shl    $0x10,%ebx
80104aa5:	09 d8                	or     %ebx,%eax
80104aa7:	09 f8                	or     %edi,%eax
80104aa9:	c1 e7 08             	shl    $0x8,%edi
80104aac:	09 f8                	or     %edi,%eax
  asm volatile("cld; rep stosl" :
80104aae:	89 d7                	mov    %edx,%edi
80104ab0:	fc                   	cld    
80104ab1:	f3 ab                	rep stos %eax,%es:(%edi)
  } else
    stosb(dst, c, n);
  return dst;
}
80104ab3:	5b                   	pop    %ebx
80104ab4:	89 d0                	mov    %edx,%eax
80104ab6:	5f                   	pop    %edi
80104ab7:	5d                   	pop    %ebp
80104ab8:	c3                   	ret    
...
80104ac2:	fc                   	cld    
80104ac3:	f3 aa                	rep stos %al,%es:(%edi)
80104ac5:	5b                   	pop    %ebx
...
80104ae0:	74 2e                	je     80104b10 <memcmp+0x40>
80104ae2:	01 c6                	add    %eax,%esi
80104ae4:	eb 14                	jmp    80104afa <memcmp+0x2a>
...
80104af3:	83 c2 01             	add    $0x1,%edx
  while(n-- > 0){
80104af6:	39 f0                	cmp    %esi,%eax
80104af8:	74 16                	je     80104b10 <memcmp+0x40>
    if(*s1 != *s2)
80104afa:	0f b6 0a             	movzbl (%edx),%ecx
80104afd:	0f b6 18             	movzbl (%eax),%ebx
80104b00:	38 d9                	cmp    %bl,%cl
80104b02:	74 ec                	je     80104af0 <memcmp+0x20>
      return *s1 - *s2;
80104b04:	0f b6 c1             	movzbl %cl,%eax
80104b07:	29 d8                	sub    %ebx,%eax
  }
...
80104b2b:	8b 75 0c             	mov    0xc(%ebp),%esi
  ...
  d = dst;
  if(s < d && s + n > d){
80104b2e:	39 d6                	cmp    %edx,%esi
80104b30:	73 26                	jae    80104b58 <memmove+0x38>
80104b32:	8d 3c 0e             	lea    (%esi,%ecx,1),%edi
80104b35:	39 fa                	cmp    %edi,%edx
80104b37:	73 1f                	jae    80104b58 <memmove+0x38>
80104b39:	8d 41 ff             	lea    -0x1(%ecx),%eax
    s += n;
    d += n;
    while(n-- > 0)
80104b3c:	85 c9                	test   %ecx,%ecx
80104b3e:	74 0c                	je     80104b4c <memmove+0x2c>
      *--d = *--s;
80104b40:	0f b6 0c 06          	movzbl (%esi,%eax,1),%ecx
80104b44:	88 0c 02             	mov    %cl,(%edx,%eax,1)
    while(n-- > 0)
80104b47:	83 e8 01             	sub    $0x1,%eax
80104b4a:	73 f4                	jae    80104b40 <memmove+0x20>
  } else
    while(n-- > 0)
      *d++ = *s++;
...
80104b4c:	5e                   	pop    %esi
80104b4d:	89 d0                	mov    %edx,%eax
80104b4f:	5f                   	pop    %edi
80104b50:	5d                   	pop    %ebp
80104b51:	c3                   	ret    
80104b52:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    while(n-- > 0)
80104b58:	8d 04 0e             	lea    (%esi,%ecx,1),%eax
80104b5b:	89 d7                	mov    %edx,%edi
80104b5d:	85 c9                	test   %ecx,%ecx
80104b5f:	74 eb                	je     80104b4c <memmove+0x2c>
80104b61:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      *d++ = *s++;
80104b68:	a4                   	movsb  %ds:(%esi),%es:(%edi)
    while(n-- > 0)
80104b69:	39 c6                	cmp    %eax,%esi
80104b6b:	75 fb                	jne    80104b68 <memmove+0x48>
}
80104b6d:	5e                   	pop    %esi
...
80104b80:	eb 9e                	jmp    80104b20 <memmove>
...
80104ba0:	74 2e                	je     80104bd0 <strncmp+0x40>
80104ba2:	01 d6                	add    %edx,%esi
80104ba4:	eb 18                	jmp    80104bbe <strncmp+0x2e>
80104ba6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80104bad:	8d 76 00             	lea    0x0(%esi),%esi
80104bb0:	38 d8                	cmp    %bl,%al
80104bb2:	75 14                	jne    80104bc8 <strncmp+0x38>
    n--, p++, q++;
80104bb4:	83 c2 01             	add    $0x1,%edx
80104bb7:	83 c1 01             	add    $0x1,%ecx
  while(n > 0 && *p && *p == *q)
80104bba:	39 f2                	cmp    %esi,%edx
80104bbc:	74 12                	je     80104bd0 <strncmp+0x40>
80104bbe:	0f b6 01             	movzbl (%ecx),%eax
80104bc1:	0f b6 1a             	movzbl (%edx),%ebx
80104bc4:	84 c0                	test   %al,%al
80104bc6:	75 e8                	jne    80104bb0 <strncmp+0x20>
  if(n == 0)
    return 0;
  return (uchar)*p - (uchar)*q;
80104bc8:	29 d8                	sub    %ebx,%eax
}
80104bca:	5b                   	pop    %ebx
80104bcb:	5e                   	pop    %esi
80104bcc:	5d                   	pop    %ebp
...
80104be9:	8b 4d 10             	mov    0x10(%ebp),%ecx
  char *os;

  os = s;
  while(n-- > 0 && (*s++ = *t++) != 0)
80104bec:	89 f0                	mov    %esi,%eax
80104bee:	eb 15                	jmp    80104c05 <strncpy+0x25>
80104bf0:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
80104bf4:	8b 7d 0c             	mov    0xc(%ebp),%edi
80104bf7:	83 c0 01             	add    $0x1,%eax
80104bfa:	0f b6 57 ff          	movzbl -0x1(%edi),%edx
80104bfe:	88 50 ff             	mov    %dl,-0x1(%eax)
80104c01:	84 d2                	test   %dl,%dl
80104c03:	74 09                	je     80104c0e <strncpy+0x2e>
80104c05:	89 cb                	mov    %ecx,%ebx
80104c07:	83 e9 01             	sub    $0x1,%ecx
80104c0a:	85 db                	test   %ebx,%ebx
80104c0c:	7f e2                	jg     80104bf0 <strncpy+0x10>
    ;
  while(n-- > 0)
80104c0e:	89 c2                	mov    %eax,%edx
80104c10:	85 c9                	test   %ecx,%ecx
80104c12:	7e 17                	jle    80104c2b <strncpy+0x4b>
80104c14:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    *s++ = 0;
80104c18:	83 c2 01             	add    $0x1,%edx
80104c1b:	89 c1                	mov    %eax,%ecx
80104c1d:	c6 42 ff 00          	movb   $0x0,-0x1(%edx)
  while(n-- > 0)
80104c21:	29 d1                	sub    %edx,%ecx
80104c23:	8d 4c 0b ff          	lea    -0x1(%ebx,%ecx,1),%ecx
80104c27:	85 c9                	test   %ecx,%ecx
80104c29:	7f ed                	jg     80104c18 <strncpy+0x38>
  return os;
}
80104c2b:	5b                   	pop    %ebx
80104c2c:	89 f0                	mov    %esi,%eax
80104c2e:	5e                   	pop    %esi
80104c2f:	5f                   	pop    %edi
80104c30:	5d                   	pop    %ebp
80104c31:	c3                   	ret    
...
80104cb7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
80104cba:	e8 31 ed ff ff       	call   801039f0 <myproc>
...
80104cf7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
80104cfa:	e8 f1 ec ff ff       	call   801039f0 <myproc>

  if(addr >= curproc->sz)
80104cff:	39 18                	cmp    %ebx,(%eax)
80104d01:	76 2d                	jbe    80104d30 <fetchstr+0x40>
    return -1;
  *pp = (char*)addr;
...
80104d0c:	73 22                	jae    80104d30 <fetchstr+0x40>
80104d0e:	89 d8                	mov    %ebx,%eax
80104d10:	eb 0d                	jmp    80104d1f <fetchstr+0x2f>
80104d12:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80104d18:	83 c0 01             	add    $0x1,%eax
80104d1b:	39 c2                	cmp    %eax,%edx
80104d1d:	76 11                	jbe    80104d30 <fetchstr+0x40>
    if(*s == 0)
80104d1f:	80 38 00             	cmpb   $0x0,(%eax)
80104d22:	75 f4                	jne    80104d18 <fetchstr+0x28>
      return s - *pp;
80104d24:	29 d8                	sub    %ebx,%eax
  }
  return -1;
}
...
80104d45:	e8 a6 ec ff ff       	call   801039f0 <myproc>
...
80104d53:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104d56:	e8 95 ec ff ff       	call   801039f0 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104d96:	83 ec 0c             	sub    $0xc,%esp
  int i;
  struct proc *curproc = myproc();
80104d99:	e8 52 ec ff ff       	call   801039f0 <myproc>
80104d9e:	89 c6                	mov    %eax,%esi
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104da0:	e8 4b ec ff ff       	call   801039f0 <myproc>
80104da5:	8b 55 08             	mov    0x8(%ebp),%edx
80104da8:	8b 40 18             	mov    0x18(%eax),%eax
80104dab:	8b 40 44             	mov    0x44(%eax),%eax
80104dae:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104db1:	e8 3a ec ff ff       	call   801039f0 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104db6:	8d 7b 04             	lea    0x4(%ebx),%edi
  if(addr >= curproc->sz || addr+4 > curproc->sz)
80104db9:	8b 00                	mov    (%eax),%eax
80104dbb:	39 c7                	cmp    %eax,%edi
80104dbd:	73 31                	jae    80104df0 <argptr+0x60>
80104dbf:	8d 4b 08             	lea    0x8(%ebx),%ecx
80104dc2:	39 c8                	cmp    %ecx,%eax
80104dc4:	72 2a                	jb     80104df0 <argptr+0x60>
...
80104dc6:	8b 55 10             	mov    0x10(%ebp),%edx
  *ip = *(int*)(addr);
80104dc9:	8b 43 04             	mov    0x4(%ebx),%eax
  if(size < 0 || (uint)i >= curproc->sz || (uint)i+size > curproc->sz)
80104dcc:	85 d2                	test   %edx,%edx
80104dce:	78 20                	js     80104df0 <argptr+0x60>
80104dd0:	8b 16                	mov    (%esi),%edx
80104dd2:	39 c2                	cmp    %eax,%edx
80104dd4:	76 1a                	jbe    80104df0 <argptr+0x60>
80104dd6:	8b 5d 10             	mov    0x10(%ebp),%ebx
80104dd9:	01 c3                	add    %eax,%ebx
80104ddb:	39 da                	cmp    %ebx,%edx
80104ddd:	72 11                	jb     80104df0 <argptr+0x60>
    return -1;
  *pp = (char*)i;
...
80104df5:	eb ef                	jmp    80104de6 <argptr+0x56>
...
80104e04:	53                   	push   %ebx
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104e05:	e8 e6 eb ff ff       	call   801039f0 <myproc>
...
80104e13:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104e16:	e8 d5 eb ff ff       	call   801039f0 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104e1b:	8d 73 04             	lea    0x4(%ebx),%esi
  if(addr >= curproc->sz || addr+4 > curproc->sz)
80104e1e:	8b 00                	mov    (%eax),%eax
80104e20:	39 c6                	cmp    %eax,%esi
80104e22:	73 44                	jae    80104e68 <argstr+0x68>
80104e24:	8d 53 08             	lea    0x8(%ebx),%edx
80104e27:	39 d0                	cmp    %edx,%eax
80104e29:	72 3d                	jb     80104e68 <argstr+0x68>
  *ip = *(int*)(addr);
80104e2b:	8b 5b 04             	mov    0x4(%ebx),%ebx
  struct proc *curproc = myproc();
80104e2e:	e8 bd eb ff ff       	call   801039f0 <myproc>
  if(addr >= curproc->sz)
80104e33:	3b 18                	cmp    (%eax),%ebx
80104e35:	73 31                	jae    80104e68 <argstr+0x68>
  *pp = (char*)addr;
80104e37:	8b 55 0c             	mov    0xc(%ebp),%edx
80104e3a:	89 1a                	mov    %ebx,(%edx)
  ep = (char*)curproc->sz;
80104e3c:	8b 10                	mov    (%eax),%edx
  for(s = *pp; s < ep; s++){
80104e3e:	39 d3                	cmp    %edx,%ebx
80104e40:	73 26                	jae    80104e68 <argstr+0x68>
80104e42:	89 d8                	mov    %ebx,%eax
80104e44:	eb 11                	jmp    80104e57 <argstr+0x57>
...
80104e55:	76 11                	jbe    80104e68 <argstr+0x68>
    if(*s == 0)
80104e57:	80 38 00             	cmpb   $0x0,(%eax)
80104e5a:	75 f4                	jne    80104e50 <argstr+0x50>
      return s - *pp;
80104e5c:	29 d8                	sub    %ebx,%eax
  int addr;
  if(argint(n, &addr) < 0)
    return -1;
...
80104e84:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104e87:	e8 64 eb ff ff       	call   801039f0 <myproc>
80104e8c:	89 c3                	mov    %eax,%ebx

  num = curproc->tf->eax;
80104e8e:	8b 40 18             	mov    0x18(%eax),%eax
80104e91:	8b 40 1c             	mov    0x1c(%eax),%eax
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104e94:	8d 50 ff             	lea    -0x1(%eax),%edx
80104e97:	83 fa 16             	cmp    $0x16,%edx
80104e9a:	77 24                	ja     80104ec0 <syscall+0x40>
80104e9c:	8b 14 85 60 7f 10 80 	mov    -0x7fef80a0(,%eax,4),%edx
80104ea3:	85 d2                	test   %edx,%edx
80104ea5:	74 19                	je     80104ec0 <syscall+0x40>
    curproc->tf->eax = syscalls[num]();
80104ea7:	ff d2                	call   *%edx
80104ea9:	89 c2                	mov    %eax,%edx
80104eab:	8b 43 18             	mov    0x18(%ebx),%eax
80104eae:	89 50 1c             	mov    %edx,0x1c(%eax)
  } else {
...
80104ec0:	50                   	push   %eax
            curproc->pid, curproc->name, num);
80104ec1:	8d 43 6c             	lea    0x6c(%ebx),%eax
    cprintf("%d %s: unknown sys call %d\n",
80104ec4:	50                   	push   %eax
80104ec5:	ff 73 10             	push   0x10(%ebx)
80104ec8:	68 31 7f 10 80       	push   $0x80107f31
80104ecd:	e8 ce b7 ff ff       	call   801006a0 <cprintf>
    curproc->tf->eax = -1;
80104ed2:	8b 43 18             	mov    0x18(%ebx),%eax
80104ed5:	83 c4 10             	add    $0x10,%esp
80104ed8:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
}
80104edf:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104ee2:	c9                   	leave  
80104ee3:	c3                   	ret    
80104ee4:	66 90                	xchg   %ax,%ax
...
80104ef5:	8d 7d da             	lea    -0x26(%ebp),%edi
{
...
80104f07:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  if((dp = nameiparent(path, name)) == 0)
80104f0a:	e8 b1 d1 ff ff       	call   801020c0 <nameiparent>
...
80104f2c:	e8 af cd ff ff       	call   80101ce0 <dirlookup>
...
80104f3e:	e8 cd ca ff ff       	call   80101a10 <iunlockput>
    ilock(ip);
80104f43:	89 34 24             	mov    %esi,(%esp)
80104f46:	e8 35 c8 ff ff       	call   80101780 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80104f4b:	83 c4 10             	add    $0x10,%esp
80104f4e:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80104f53:	75 1b                	jne    80104f70 <create+0x80>
80104f55:	66 83 7e 50 02       	cmpw   $0x2,0x50(%esi)
80104f5a:	75 14                	jne    80104f70 <create+0x80>
...
80104f74:	31 f6                	xor    %esi,%esi
    iunlockput(ip);
80104f76:	e8 95 ca ff ff       	call   80101a10 <iunlockput>
    return 0;
...
80104f9a:	e8 71 c6 ff ff       	call   80101610 <ialloc>
80104f9f:	83 c4 10             	add    $0x10,%esp
80104fa2:	89 c6                	mov    %eax,%esi
80104fa4:	85 c0                	test   %eax,%eax
80104fa6:	0f 84 cd 00 00 00    	je     80105079 <create+0x189>
  ilock(ip);
...
80105019:	e8 b2 c6 ff ff       	call   801016d0 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
8010501e:	83 c4 0c             	add    $0xc,%esp
80105021:	ff 76 04             	push   0x4(%esi)
80105024:	68 dc 7f 10 80       	push   $0x80107fdc
80105029:	56                   	push   %esi
8010502a:	e8 b1 cf ff ff       	call   80101fe0 <dirlink>
8010502f:	83 c4 10             	add    $0x10,%esp
80105032:	85 c0                	test   %eax,%eax
80105034:	78 18                	js     8010504e <create+0x15e>
80105036:	83 ec 04             	sub    $0x4,%esp
80105039:	ff 73 04             	push   0x4(%ebx)
8010503c:	68 db 7f 10 80       	push   $0x80107fdb
80105041:	56                   	push   %esi
80105042:	e8 99 cf ff ff       	call   80101fe0 <dirlink>
80105047:	83 c4 10             	add    $0x10,%esp
8010504a:	85 c0                	test   %eax,%eax
8010504c:	79 92                	jns    80104fe0 <create+0xf0>
      panic("create dots");
8010504e:	83 ec 0c             	sub    $0xc,%esp
80105051:	68 cf 7f 10 80       	push   $0x80107fcf
...
80105060:	8d 65 f4             	lea    -0xc(%ebp),%esp
    return 0;
80105063:	31 f6                	xor    %esi,%esi
}
80105065:	5b                   	pop    %ebx
80105066:	89 f0                	mov    %esi,%eax
80105068:	5e                   	pop    %esi
80105069:	5f                   	pop    %edi
8010506a:	5d                   	pop    %ebp
8010506b:	c3                   	ret    
...
8010506f:	68 de 7f 10 80       	push   $0x80107fde
80105074:	e8 07 b3 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80105079:	83 ec 0c             	sub    $0xc,%esp
8010507c:	68 c0 7f 10 80       	push   $0x80107fc0
80105081:	e8 fa b2 ff ff       	call   80100380 <panic>
...
8010509e:	e8 9d fc ff ff       	call   80104d40 <argint>
...
801050b0:	e8 3b e9 ff ff       	call   801039f0 <myproc>
...
801050be:	74 20                	je     801050e0 <sys_dup+0x50>
  struct proc *curproc = myproc();
801050c0:	e8 2b e9 ff ff       	call   801039f0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801050f8:	e8 a3 bd ff ff       	call   80100ea0 <filedup>
  return fd;
...
8010511e:	e8 1d fc ff ff       	call   80104d40 <argint>
...
80105130:	e8 bb e8 ff ff       	call   801039f0 <myproc>
...
80105149:	e8 f2 fb ff ff       	call   80104d40 <argint>
...
8010515e:	e8 2d fc ff ff       	call   80104d90 <argptr>
...
80105174:	e8 a7 be ff ff       	call   80101020 <fileread>
...
8010519e:	e8 9d fb ff ff       	call   80104d40 <argint>
...
801051b0:	e8 3b e8 ff ff       	call   801039f0 <myproc>
...
801051c9:	e8 72 fb ff ff       	call   80104d40 <argint>
...
801051de:	e8 ad fb ff ff       	call   80104d90 <argptr>
...
801051f4:	e8 b7 be ff ff       	call   801010b0 <filewrite>
...
8010521e:	e8 1d fb ff ff       	call   80104d40 <argint>
...
80105230:	e8 bb e7 ff ff       	call   801039f0 <myproc>
...
80105241:	74 25                	je     80105268 <sys_close+0x58>
  myproc()->ofile[fd] = 0;
80105243:	e8 a8 e7 ff ff       	call   801039f0 <myproc>
  fileclose(f);
...
80105254:	e8 97 bc ff ff       	call   80100ef0 <fileclose>
  return 0;
...
8010527e:	e8 bd fa ff ff       	call   80104d40 <argint>
...
801052a8:	e8 e3 fa ff ff       	call   80104d90 <argptr>
...
801052bb:	e8 10 bd ff ff       	call   80100fd0 <filestat>
...
801052ef:	e8 0c fb ff ff       	call   80104e00 <argstr>
...
80105358:	e8 73 c3 ff ff       	call   801016d0 <iupdate>
  iunlock(ip);
...
8010536b:	e8 50 cd ff ff       	call   801020c0 <nameiparent>
...
80105393:	e8 48 cc ff ff       	call   80101fe0 <dirlink>
...
801053ab:	e8 00 c5 ff ff       	call   801018b0 <iput>
  end_op();
801053b0:	e8 1b da ff ff       	call   80102dd0 <end_op>
  return 0;
...
801053cc:	e8 3f c6 ff ff       	call   80101a10 <iunlockput>
    goto bad;
...
801053e5:	e8 e6 c2 ff ff       	call   801016d0 <iupdate>
  iunlockput(ip);
801053ea:	89 1c 24             	mov    %ebx,(%esp)
801053ed:	e8 1e c6 ff ff       	call   80101a10 <iunlockput>
  end_op();
801053f2:	e8 d9 d9 ff ff       	call   80102dd0 <end_op>
  return -1;
...
80105405:	e8 06 c6 ff ff       	call   80101a10 <iunlockput>
    end_op();
8010540a:	e8 c1 d9 ff ff       	call   80102dd0 <end_op>
    return -1;
8010540f:	83 c4 10             	add    $0x10,%esp
80105412:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105417:	eb a1                	jmp    801053ba <sys_link+0xda>
    end_op();
80105419:	e8 b2 d9 ff ff       	call   80102dd0 <end_op>
    return -1;
8010541e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105423:	eb 95                	jmp    801053ba <sys_link+0xda>
80105425:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
80105434:	56                   	push   %esi
  if(argstr(0, &path) < 0)
80105435:	8d 45 c0             	lea    -0x40(%ebp),%eax
{
...
8010543f:	e8 bc f9 ff ff       	call   80104e00 <argstr>
80105444:	83 c4 10             	add    $0x10,%esp
80105447:	85 c0                	test   %eax,%eax
80105449:	0f 88 7a 01 00 00    	js     801055c9 <sys_unlink+0x199>
  begin_op();
8010544f:	e8 0c d9 ff ff       	call   80102d60 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80105454:	8d 5d ca             	lea    -0x36(%ebp),%ebx
80105457:	83 ec 08             	sub    $0x8,%esp
8010545a:	53                   	push   %ebx
8010545b:	ff 75 c0             	push   -0x40(%ebp)
8010545e:	e8 5d cc ff ff       	call   801020c0 <nameiparent>
80105463:	83 c4 10             	add    $0x10,%esp
80105466:	89 45 b4             	mov    %eax,-0x4c(%ebp)
80105469:	85 c0                	test   %eax,%eax
8010546b:	0f 84 62 01 00 00    	je     801055d3 <sys_unlink+0x1a3>
  ilock(dp);
80105471:	8b 7d b4             	mov    -0x4c(%ebp),%edi
80105474:	83 ec 0c             	sub    $0xc,%esp
80105477:	57                   	push   %edi
80105478:	e8 03 c3 ff ff       	call   80101780 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
8010547d:	58                   	pop    %eax
8010547e:	5a                   	pop    %edx
8010547f:	68 dc 7f 10 80       	push   $0x80107fdc
80105484:	53                   	push   %ebx
80105485:	e8 36 c8 ff ff       	call   80101cc0 <namecmp>
8010548a:	83 c4 10             	add    $0x10,%esp
8010548d:	85 c0                	test   %eax,%eax
8010548f:	0f 84 fb 00 00 00    	je     80105590 <sys_unlink+0x160>
80105495:	83 ec 08             	sub    $0x8,%esp
80105498:	68 db 7f 10 80       	push   $0x80107fdb
8010549d:	53                   	push   %ebx
8010549e:	e8 1d c8 ff ff       	call   80101cc0 <namecmp>
801054a3:	83 c4 10             	add    $0x10,%esp
801054a6:	85 c0                	test   %eax,%eax
801054a8:	0f 84 e2 00 00 00    	je     80105590 <sys_unlink+0x160>
...
801054b7:	e8 24 c8 ff ff       	call   80101ce0 <dirlookup>
801054bc:	83 c4 10             	add    $0x10,%esp
801054bf:	89 c3                	mov    %eax,%ebx
801054c1:	85 c0                	test   %eax,%eax
801054c3:	0f 84 c7 00 00 00    	je     80105590 <sys_unlink+0x160>
  ilock(ip);
801054c9:	83 ec 0c             	sub    $0xc,%esp
801054cc:	50                   	push   %eax
801054cd:	e8 ae c2 ff ff       	call   80101780 <ilock>
  if(ip->nlink < 1)
801054d2:	83 c4 10             	add    $0x10,%esp
801054d5:	66 83 7b 56 00       	cmpw   $0x0,0x56(%ebx)
801054da:	0f 8e 1c 01 00 00    	jle    801055fc <sys_unlink+0x1cc>
...
801054f2:	e8 89 f5 ff ff       	call   80104a80 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
801054f7:	6a 10                	push   $0x10
801054f9:	ff 75 c4             	push   -0x3c(%ebp)
801054fc:	57                   	push   %edi
801054fd:	ff 75 b4             	push   -0x4c(%ebp)
80105500:	e8 8b c6 ff ff       	call   80101b90 <writei>
80105505:	83 c4 20             	add    $0x20,%esp
80105508:	83 f8 10             	cmp    $0x10,%eax
8010550b:	0f 85 de 00 00 00    	jne    801055ef <sys_unlink+0x1bf>
  if(ip->type == T_DIR){
80105511:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80105516:	0f 84 94 00 00 00    	je     801055b0 <sys_unlink+0x180>
  iunlockput(dp);
8010551c:	83 ec 0c             	sub    $0xc,%esp
8010551f:	ff 75 b4             	push   -0x4c(%ebp)
80105522:	e8 e9 c4 ff ff       	call   80101a10 <iunlockput>
  ip->nlink--;
80105527:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
8010552c:	89 1c 24             	mov    %ebx,(%esp)
8010552f:	e8 9c c1 ff ff       	call   801016d0 <iupdate>
  iunlockput(ip);
80105534:	89 1c 24             	mov    %ebx,(%esp)
80105537:	e8 d4 c4 ff ff       	call   80101a10 <iunlockput>
  end_op();
8010553c:	e8 8f d8 ff ff       	call   80102dd0 <end_op>
  return 0;
...
80105556:	be 20 00 00 00       	mov    $0x20,%esi
8010555b:	eb 0b                	jmp    80105568 <sys_unlink+0x138>
8010555d:	8d 76 00             	lea    0x0(%esi),%esi
80105560:	83 c6 10             	add    $0x10,%esi
80105563:	3b 73 58             	cmp    0x58(%ebx),%esi
80105566:	73 82                	jae    801054ea <sys_unlink+0xba>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105568:	6a 10                	push   $0x10
8010556a:	56                   	push   %esi
8010556b:	57                   	push   %edi
8010556c:	53                   	push   %ebx
8010556d:	e8 1e c5 ff ff       	call   80101a90 <readi>
80105572:	83 c4 10             	add    $0x10,%esp
80105575:	83 f8 10             	cmp    $0x10,%eax
80105578:	75 68                	jne    801055e2 <sys_unlink+0x1b2>
    if(de.inum != 0)
8010557a:	66 83 7d d8 00       	cmpw   $0x0,-0x28(%ebp)
8010557f:	74 df                	je     80105560 <sys_unlink+0x130>
    iunlockput(ip);
80105581:	83 ec 0c             	sub    $0xc,%esp
80105584:	53                   	push   %ebx
80105585:	e8 86 c4 ff ff       	call   80101a10 <iunlockput>
    goto bad;
8010558a:	83 c4 10             	add    $0x10,%esp
8010558d:	8d 76 00             	lea    0x0(%esi),%esi
  iunlockput(dp);
80105590:	83 ec 0c             	sub    $0xc,%esp
80105593:	ff 75 b4             	push   -0x4c(%ebp)
80105596:	e8 75 c4 ff ff       	call   80101a10 <iunlockput>
  end_op();
8010559b:	e8 30 d8 ff ff       	call   80102dd0 <end_op>
  return -1;
801055a0:	83 c4 10             	add    $0x10,%esp
801055a3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801055a8:	eb 9c                	jmp    80105546 <sys_unlink+0x116>
801055aa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    dp->nlink--;
801055b0:	8b 45 b4             	mov    -0x4c(%ebp),%eax
    iupdate(dp);
801055b3:	83 ec 0c             	sub    $0xc,%esp
    dp->nlink--;
801055b6:	66 83 68 56 01       	subw   $0x1,0x56(%eax)
    iupdate(dp);
801055bb:	50                   	push   %eax
801055bc:	e8 0f c1 ff ff       	call   801016d0 <iupdate>
801055c1:	83 c4 10             	add    $0x10,%esp
801055c4:	e9 53 ff ff ff       	jmp    8010551c <sys_unlink+0xec>
    return -1;
801055c9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801055ce:	e9 73 ff ff ff       	jmp    80105546 <sys_unlink+0x116>
    end_op();
801055d3:	e8 f8 d7 ff ff       	call   80102dd0 <end_op>
    return -1;
801055d8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801055dd:	e9 64 ff ff ff       	jmp    80105546 <sys_unlink+0x116>
      panic("isdirempty: readi");
801055e2:	83 ec 0c             	sub    $0xc,%esp
801055e5:	68 00 80 10 80       	push   $0x80108000
801055ea:	e8 91 ad ff ff       	call   80100380 <panic>
    panic("unlink: writei");
801055ef:	83 ec 0c             	sub    $0xc,%esp
801055f2:	68 12 80 10 80       	push   $0x80108012
801055f7:	e8 84 ad ff ff       	call   80100380 <panic>
    panic("unlink: nlink < 1");
801055fc:	83 ec 0c             	sub    $0xc,%esp
801055ff:	68 ee 7f 10 80       	push   $0x80107fee
80105604:	e8 77 ad ff ff       	call   80100380 <panic>
...
80105615:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
...
8010561f:	e8 dc f7 ff ff       	call   80104e00 <argstr>
80105624:	83 c4 10             	add    $0x10,%esp
80105627:	85 c0                	test   %eax,%eax
80105629:	0f 88 8e 00 00 00    	js     801056bd <sys_open+0xad>
8010562f:	83 ec 08             	sub    $0x8,%esp
80105632:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105635:	50                   	push   %eax
80105636:	6a 01                	push   $0x1
80105638:	e8 03 f7 ff ff       	call   80104d40 <argint>
8010563d:	83 c4 10             	add    $0x10,%esp
80105640:	85 c0                	test   %eax,%eax
80105642:	78 79                	js     801056bd <sys_open+0xad>
    return -1;

  begin_op();
80105644:	e8 17 d7 ff ff       	call   80102d60 <begin_op>

  if(omode & O_CREATE){
80105649:	f6 45 e5 02          	testb  $0x2,-0x1b(%ebp)
8010564d:	75 79                	jne    801056c8 <sys_open+0xb8>
    if(ip == 0){
      end_op();
      return -1;
    }
...
80105652:	ff 75 e0             	push   -0x20(%ebp)
80105655:	e8 46 ca ff ff       	call   801020a0 <namei>
8010565a:	83 c4 10             	add    $0x10,%esp
8010565d:	89 c6                	mov    %eax,%esi
8010565f:	85 c0                	test   %eax,%eax
80105661:	0f 84 7e 00 00 00    	je     801056e5 <sys_open+0xd5>
      end_op();
      return -1;
    }
    ilock(ip);
...
8010566b:	e8 10 c1 ff ff       	call   80101780 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80105670:	83 c4 10             	add    $0x10,%esp
80105673:	66 83 7e 50 01       	cmpw   $0x1,0x50(%esi)
80105678:	0f 84 c2 00 00 00    	je     80105740 <sys_open+0x130>
      end_op();
      return -1;
    }
  }
...
8010567e:	e8 ad b7 ff ff       	call   80100e30 <filealloc>
80105683:	89 c7                	mov    %eax,%edi
80105685:	85 c0                	test   %eax,%eax
80105687:	74 23                	je     801056ac <sys_open+0x9c>
  struct proc *curproc = myproc();
80105689:	e8 62 e3 ff ff       	call   801039f0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
8010568e:	31 db                	xor    %ebx,%ebx
    if(curproc->ofile[fd] == 0){
80105690:	8b 54 98 28          	mov    0x28(%eax,%ebx,4),%edx
80105694:	85 d2                	test   %edx,%edx
80105696:	74 60                	je     801056f8 <sys_open+0xe8>
  for(fd = 0; fd < NOFILE; fd++){
80105698:	83 c3 01             	add    $0x1,%ebx
8010569b:	83 fb 10             	cmp    $0x10,%ebx
8010569e:	75 f0                	jne    80105690 <sys_open+0x80>
    if(f)
      fileclose(f);
801056a0:	83 ec 0c             	sub    $0xc,%esp
801056a3:	57                   	push   %edi
801056a4:	e8 47 b8 ff ff       	call   80100ef0 <fileclose>
801056a9:	83 c4 10             	add    $0x10,%esp
    iunlockput(ip);
801056ac:	83 ec 0c             	sub    $0xc,%esp
801056af:	56                   	push   %esi
801056b0:	e8 5b c3 ff ff       	call   80101a10 <iunlockput>
    end_op();
801056b5:	e8 16 d7 ff ff       	call   80102dd0 <end_op>
    return -1;
801056ba:	83 c4 10             	add    $0x10,%esp
801056bd:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
801056c2:	eb 6d                	jmp    80105731 <sys_open+0x121>
...
801056d0:	ba 02 00 00 00       	mov    $0x2,%edx
801056d5:	6a 00                	push   $0x0
801056d7:	e8 14 f8 ff ff       	call   80104ef0 <create>
    if(ip == 0){
801056dc:	83 c4 10             	add    $0x10,%esp
    ip = create(path, T_FILE, 0, 0);
801056df:	89 c6                	mov    %eax,%esi
    if(ip == 0){
801056e1:	85 c0                	test   %eax,%eax
801056e3:	75 99                	jne    8010567e <sys_open+0x6e>
      end_op();
801056e5:	e8 e6 d6 ff ff       	call   80102dd0 <end_op>
      return -1;
801056ea:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
801056ef:	eb 40                	jmp    80105731 <sys_open+0x121>
801056f1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  }
  iunlock(ip);
801056f8:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
801056fb:	89 7c 98 28          	mov    %edi,0x28(%eax,%ebx,4)
  iunlock(ip);
...
80105705:	e8 c6 d6 ff ff       	call   80102dd0 <end_op>
  ...
  f->type = FD_INODE;
8010570a:	c7 07 02 00 00 00    	movl   $0x2,(%edi)
  f->ip = ip;
  f->off = 0;
  f->readable = !(omode & O_WRONLY);
80105710:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80105713:	83 c4 10             	add    $0x10,%esp
  f->ip = ip;
80105716:	89 77 10             	mov    %esi,0x10(%edi)
  f->readable = !(omode & O_WRONLY);
80105719:	89 d0                	mov    %edx,%eax
  f->off = 0;
8010571b:	c7 47 14 00 00 00 00 	movl   $0x0,0x14(%edi)
  f->readable = !(omode & O_WRONLY);
80105722:	f7 d0                	not    %eax
80105724:	83 e0 01             	and    $0x1,%eax
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80105727:	83 e2 03             	and    $0x3,%edx
  f->readable = !(omode & O_WRONLY);
8010572a:	88 47 08             	mov    %al,0x8(%edi)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
8010572d:	0f 95 47 09          	setne  0x9(%edi)
  return fd;
}
80105731:	8d 65 f4             	lea    -0xc(%ebp),%esp
80105734:	89 d8                	mov    %ebx,%eax
80105736:	5b                   	pop    %ebx
80105737:	5e                   	pop    %esi
80105738:	5f                   	pop    %edi
80105739:	5d                   	pop    %ebp
...
8010573f:	90                   	nop
    if(ip->type == T_DIR && omode != O_RDONLY){
80105740:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80105743:	85 c9                	test   %ecx,%ecx
80105745:	0f 84 33 ff ff ff    	je     8010567e <sys_open+0x6e>
8010574b:	e9 5c ff ff ff       	jmp    801056ac <sys_open+0x9c>
...
8010578f:	e8 7c c2 ff ff       	call   80101a10 <iunlockput>
  end_op();
...
8010581e:	e8 ed c1 ff ff       	call   80101a10 <iunlockput>
  end_op();
80105823:	e8 a8 d5 ff ff       	call   80102dd0 <end_op>
  return 0;
...
80105845:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105848:	e8 a3 e1 ff ff       	call   801039f0 <myproc>
8010584d:	89 c6                	mov    %eax,%esi
  
  begin_op();
8010584f:	e8 0c d5 ff ff       	call   80102d60 <begin_op>
  if(argstr(0, &path) < 0 || (ip = namei(path)) == 0){
80105854:	83 ec 08             	sub    $0x8,%esp
80105857:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010585a:	50                   	push   %eax
8010585b:	6a 00                	push   $0x0
8010585d:	e8 9e f5 ff ff       	call   80104e00 <argstr>
80105862:	83 c4 10             	add    $0x10,%esp
80105865:	85 c0                	test   %eax,%eax
80105867:	78 77                	js     801058e0 <sys_chdir+0xa0>
80105869:	83 ec 0c             	sub    $0xc,%esp
8010586c:	ff 75 f4             	push   -0xc(%ebp)
8010586f:	e8 2c c8 ff ff       	call   801020a0 <namei>
80105874:	83 c4 10             	add    $0x10,%esp
80105877:	89 c3                	mov    %eax,%ebx
80105879:	85 c0                	test   %eax,%eax
8010587b:	74 63                	je     801058e0 <sys_chdir+0xa0>
    end_op();
    return -1;
  }
  ilock(ip);
...
80105881:	e8 fa be ff ff       	call   80101780 <ilock>
  if(ip->type != T_DIR){
80105886:	83 c4 10             	add    $0x10,%esp
80105889:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
8010588e:	75 30                	jne    801058c0 <sys_chdir+0x80>
    iunlockput(ip);
    end_op();
    return -1;
  }
...
80105894:	e8 c7 bf ff ff       	call   80101860 <iunlock>
  iput(curproc->cwd);
80105899:	58                   	pop    %eax
8010589a:	ff 76 68             	push   0x68(%esi)
8010589d:	e8 0e c0 ff ff       	call   801018b0 <iput>
  end_op();
801058a2:	e8 29 d5 ff ff       	call   80102dd0 <end_op>
  curproc->cwd = ip;
801058a7:	89 5e 68             	mov    %ebx,0x68(%esi)
  return 0;
...
801058ea:	eb c3                	jmp    801058af <sys_chdir+0x6f>
...
801058f5:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
{
801058fb:	53                   	push   %ebx
801058fc:	81 ec a4 00 00 00    	sub    $0xa4,%esp
  if(argstr(0, &path) < 0 || argint(1, (int*)&uargv) < 0){
80105902:	50                   	push   %eax
80105903:	6a 00                	push   $0x0
80105905:	e8 f6 f4 ff ff       	call   80104e00 <argstr>
8010590a:	83 c4 10             	add    $0x10,%esp
8010590d:	85 c0                	test   %eax,%eax
8010590f:	0f 88 87 00 00 00    	js     8010599c <sys_exec+0xac>
80105915:	83 ec 08             	sub    $0x8,%esp
80105918:	8d 85 60 ff ff ff    	lea    -0xa0(%ebp),%eax
8010591e:	50                   	push   %eax
8010591f:	6a 01                	push   $0x1
80105921:	e8 1a f4 ff ff       	call   80104d40 <argint>
80105926:	83 c4 10             	add    $0x10,%esp
80105929:	85 c0                	test   %eax,%eax
8010592b:	78 6f                	js     8010599c <sys_exec+0xac>
    return -1;
  }
  memset(argv, 0, sizeof(argv));
8010592d:	83 ec 04             	sub    $0x4,%esp
80105930:	8d b5 68 ff ff ff    	lea    -0x98(%ebp),%esi
  for(i=0;; i++){
80105936:	31 db                	xor    %ebx,%ebx
  memset(argv, 0, sizeof(argv));
80105938:	68 80 00 00 00       	push   $0x80
8010593d:	6a 00                	push   $0x0
8010593f:	56                   	push   %esi
80105940:	e8 3b f1 ff ff       	call   80104a80 <memset>
...
80105953:	8d 85 64 ff ff ff    	lea    -0x9c(%ebp),%eax
80105959:	8d 3c 9d 00 00 00 00 	lea    0x0(,%ebx,4),%edi
80105960:	50                   	push   %eax
80105961:	8b 85 60 ff ff ff    	mov    -0xa0(%ebp),%eax
80105967:	01 f8                	add    %edi,%eax
80105969:	50                   	push   %eax
8010596a:	e8 41 f3 ff ff       	call   80104cb0 <fetchint>
8010596f:	83 c4 10             	add    $0x10,%esp
80105972:	85 c0                	test   %eax,%eax
80105974:	78 26                	js     8010599c <sys_exec+0xac>
      return -1;
    if(uarg == 0){
80105976:	8b 85 64 ff ff ff    	mov    -0x9c(%ebp),%eax
8010597c:	85 c0                	test   %eax,%eax
8010597e:	74 30                	je     801059b0 <sys_exec+0xc0>
      argv[i] = 0;
      break;
    }
    if(fetchstr(uarg, &argv[i]) < 0)
80105980:	83 ec 08             	sub    $0x8,%esp
80105983:	8d 14 3e             	lea    (%esi,%edi,1),%edx
80105986:	52                   	push   %edx
80105987:	50                   	push   %eax
80105988:	e8 63 f3 ff ff       	call   80104cf0 <fetchstr>
8010598d:	83 c4 10             	add    $0x10,%esp
80105990:	85 c0                	test   %eax,%eax
80105992:	78 08                	js     8010599c <sys_exec+0xac>
  for(i=0;; i++){
80105994:	83 c3 01             	add    $0x1,%ebx
    if(i >= NELEM(argv))
80105997:	83 fb 20             	cmp    $0x20,%ebx
8010599a:	75 b4                	jne    80105950 <sys_exec+0x60>
      return -1;
  }
...
801059bf:	ff b5 5c ff ff ff    	push   -0xa4(%ebp)
801059c5:	e8 e6 b0 ff ff       	call   80100ab0 <exec>
...
801059e5:	8d 45 dc             	lea    -0x24(%ebp),%eax
{
801059e8:	53                   	push   %ebx
801059e9:	83 ec 20             	sub    $0x20,%esp
  if(argptr(0, (void*)&fd, 2*sizeof(fd[0])) < 0)
801059ec:	6a 08                	push   $0x8
801059ee:	50                   	push   %eax
801059ef:	6a 00                	push   $0x0
801059f1:	e8 9a f3 ff ff       	call   80104d90 <argptr>
801059f6:	83 c4 10             	add    $0x10,%esp
801059f9:	85 c0                	test   %eax,%eax
801059fb:	78 4a                	js     80105a47 <sys_pipe+0x67>
    return -1;
  if(pipealloc(&rf, &wf) < 0)
801059fd:	83 ec 08             	sub    $0x8,%esp
80105a00:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105a03:	50                   	push   %eax
80105a04:	8d 45 e0             	lea    -0x20(%ebp),%eax
80105a07:	50                   	push   %eax
80105a08:	e8 23 da ff ff       	call   80103430 <pipealloc>
80105a0d:	83 c4 10             	add    $0x10,%esp
80105a10:	85 c0                	test   %eax,%eax
80105a12:	78 33                	js     80105a47 <sys_pipe+0x67>
    return -1;
  fd0 = -1;
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
80105a14:	8b 7d e0             	mov    -0x20(%ebp),%edi
  for(fd = 0; fd < NOFILE; fd++){
80105a17:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105a19:	e8 d2 df ff ff       	call   801039f0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
80105a1e:	66 90                	xchg   %ax,%ax
    if(curproc->ofile[fd] == 0){
80105a20:	8b 74 98 28          	mov    0x28(%eax,%ebx,4),%esi
80105a24:	85 f6                	test   %esi,%esi
80105a26:	74 28                	je     80105a50 <sys_pipe+0x70>
  for(fd = 0; fd < NOFILE; fd++){
80105a28:	83 c3 01             	add    $0x1,%ebx
80105a2b:	83 fb 10             	cmp    $0x10,%ebx
80105a2e:	75 f0                	jne    80105a20 <sys_pipe+0x40>
    if(fd0 >= 0)
      myproc()->ofile[fd0] = 0;
    fileclose(rf);
80105a30:	83 ec 0c             	sub    $0xc,%esp
80105a33:	ff 75 e0             	push   -0x20(%ebp)
80105a36:	e8 b5 b4 ff ff       	call   80100ef0 <fileclose>
    fileclose(wf);
80105a3b:	58                   	pop    %eax
80105a3c:	ff 75 e4             	push   -0x1c(%ebp)
80105a3f:	e8 ac b4 ff ff       	call   80100ef0 <fileclose>
    return -1;
80105a44:	83 c4 10             	add    $0x10,%esp
80105a47:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105a4c:	eb 53                	jmp    80105aa1 <sys_pipe+0xc1>
...
80105a57:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
80105a5a:	e8 91 df ff ff       	call   801039f0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
80105a5f:	31 d2                	xor    %edx,%edx
80105a61:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(curproc->ofile[fd] == 0){
80105a68:	8b 4c 90 28          	mov    0x28(%eax,%edx,4),%ecx
80105a6c:	85 c9                	test   %ecx,%ecx
80105a6e:	74 20                	je     80105a90 <sys_pipe+0xb0>
  for(fd = 0; fd < NOFILE; fd++){
80105a70:	83 c2 01             	add    $0x1,%edx
80105a73:	83 fa 10             	cmp    $0x10,%edx
80105a76:	75 f0                	jne    80105a68 <sys_pipe+0x88>
      myproc()->ofile[fd0] = 0;
80105a78:	e8 73 df ff ff       	call   801039f0 <myproc>
80105a7d:	c7 44 b0 08 00 00 00 	movl   $0x0,0x8(%eax,%esi,4)
80105a84:	00 
80105a85:	eb a9                	jmp    80105a30 <sys_pipe+0x50>
80105a87:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80105a8e:	66 90                	xchg   %ax,%ax
      curproc->ofile[fd] = f;
80105a90:	89 7c 90 28          	mov    %edi,0x28(%eax,%edx,4)
  }
  fd[0] = fd0;
...
{
  return fork();
80105ab0:	e9 db e0 ff ff       	jmp    80103b90 <fork>
...
80105ac3:	83 ec 08             	sub    $0x8,%esp
  exit();
80105ac6:	e8 35 e6 ff ff       	call   80104100 <exit>
...
{
  return wait();
80105ad0:	e9 5b e7 ff ff       	jmp    80104230 <wait>
...
80105afb:	ff 75 f4             	push   -0xc(%ebp)
80105afe:	e8 7d ea ff ff       	call   80104580 <kill>
...
80105b23:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105b26:	e8 c5 de ff ff       	call   801039f0 <myproc>
...
80105b47:	78 27                	js     80105b70 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
80105b49:	e8 a2 de ff ff       	call   801039f0 <myproc>
  if(growproc(n) < 0)
80105b4e:	83 ec 0c             	sub    $0xc,%esp
  addr = myproc()->sz;
80105b51:	8b 18                	mov    (%eax),%ebx
  if(growproc(n) < 0)
80105b53:	ff 75 f4             	push   -0xc(%ebp)
80105b56:	e8 b5 df ff ff       	call   80103b10 <growproc>
...
80105ba0:	68 c0 52 11 80       	push   $0x801152c0
80105ba5:	e8 16 ee ff ff       	call   801049c0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105baa:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
80105bad:	8b 1d a0 52 11 80    	mov    0x801152a0,%ebx
  while(ticks - ticks0 < n){
...
80105bc3:	68 c0 52 11 80       	push   $0x801152c0
80105bc8:	68 a0 52 11 80       	push   $0x801152a0
80105bcd:	e8 8e e8 ff ff       	call   80104460 <sleep>
  while(ticks - ticks0 < n){
80105bd2:	a1 a0 52 11 80       	mov    0x801152a0,%eax
...
80105bdf:	73 2f                	jae    80105c10 <sys_sleep+0x90>
    if(myproc()->killed){
80105be1:	e8 0a de ff ff       	call   801039f0 <myproc>
...
80105bf0:	68 c0 52 11 80       	push   $0x801152c0
80105bf5:	e8 66 ed ff ff       	call   80104960 <release>
  }
  release(&tickslock);
  return 0;
}
...
80105c13:	68 c0 52 11 80       	push   $0x801152c0
80105c18:	e8 43 ed ff ff       	call   80104960 <release>
  return 0;
...
80105c34:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105c37:	68 c0 52 11 80       	push   $0x801152c0
80105c3c:	e8 7f ed ff ff       	call   801049c0 <acquire>
  xticks = ticks;
80105c41:	8b 1d a0 52 11 80    	mov    0x801152a0,%ebx
  release(&tickslock);
80105c47:	c7 04 24 c0 52 11 80 	movl   $0x801152c0,(%esp)
80105c4e:	e8 0d ed ff ff       	call   80104960 <release>
  return xticks;
}
...
80105c63:	83 ec 08             	sub    $0x8,%esp
  yield();
80105c66:	e8 f5 e6 ff ff       	call   80104360 <yield>
  return 0;
...
80105c70:	06                   	push   %es
  pushl %fs
80105c71:	0f a0                	push   %fs
  pushl %gs
80105c73:	0f a8                	push   %gs
  pushal
80105c75:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105c76:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105c7a:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80105c7c:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80105c7e:	54                   	push   %esp
  call trap
80105c7f:	e8 ec 00 00 00       	call   80105d70 <trap>
  addl $4, %esp
80105c84:	83 c4 04             	add    $0x4,%esp
...
80105c87:	61                   	popa   
  popl %gs
80105c88:	0f a9                	pop    %gs
  popl %fs
80105c8a:	0f a1                	pop    %fs
  popl %es
80105c8c:	07                   	pop    %es
  popl %ds
80105c8d:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80105c8e:	83 c4 08             	add    $0x8,%esp
  iret
80105c91:	cf                   	iret   
...
80105cb7:	c7 04 c5 02 53 11 80 	movl   $0x8e000008,-0x7feeacfe(,%eax,8)
80105cbe:	08 00 00 8e 
80105cc2:	66 89 14 c5 00 53 11 	mov    %dx,-0x7feead00(,%eax,8)
80105cc9:	80 
80105cca:	c1 ea 10             	shr    $0x10,%edx
80105ccd:	66 89 14 c5 06 53 11 	mov    %dx,-0x7feeacfa(,%eax,8)
80105cd4:	80 
  for(i = 0; i < 256; i++)
...
80105cdf:	a1 08 b1 10 80       	mov    0x8010b108,%eax
  SETGATE(idt[T_SAMPLE128], 1, SEG_KCODE<<3, vectors[T_SAMPLE128], DPL_USER);

  initlock(&tickslock, "time");
80105ce4:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105ce7:	c7 05 02 55 11 80 08 	movl   $0xef000008,0x80115502
80105cee:	00 00 ef 
  initlock(&tickslock, "time");
80105cf1:	68 21 80 10 80       	push   $0x80108021
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105cf6:	66 a3 00 55 11 80    	mov    %ax,0x80115500
80105cfc:	c1 e8 10             	shr    $0x10,%eax
80105cff:	66 a3 06 55 11 80    	mov    %ax,0x80115506
  SETGATE(idt[T_SAMPLE128], 1, SEG_KCODE<<3, vectors[T_SAMPLE128], DPL_USER);
80105d05:	a1 08 b2 10 80       	mov    0x8010b208,%eax
  initlock(&tickslock, "time");
80105d0a:	68 c0 52 11 80       	push   $0x801152c0
  SETGATE(idt[T_SAMPLE128], 1, SEG_KCODE<<3, vectors[T_SAMPLE128], DPL_USER);
80105d0f:	66 a3 00 57 11 80    	mov    %ax,0x80115700
80105d15:	c1 e8 10             	shr    $0x10,%eax
80105d18:	c7 05 02 57 11 80 08 	movl   $0xef000008,0x80115702
80105d1f:	00 00 ef 
80105d22:	66 a3 06 57 11 80    	mov    %ax,0x80115706
  initlock(&tickslock, "time");
80105d28:	e8 c3 ea ff ff       	call   801047f0 <initlock>
}
...
80105d4b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105d4f:	b8 00 53 11 80       	mov    $0x80115300,%eax
...
80105d82:	0f 84 a8 01 00 00    	je     80105f30 <trap+0x1c0>
    if(myproc()->killed)
      exit();
    return;
  }
...
80105d8b:	0f 87 9f 00 00 00    	ja     80105e30 <trap+0xc0>
80105d91:	83 f8 1f             	cmp    $0x1f,%eax
80105d94:	0f 86 c6 00 00 00    	jbe    80105e60 <trap+0xf0>
80105d9a:	83 e8 20             	sub    $0x20,%eax
80105d9d:	83 f8 1f             	cmp    $0x1f,%eax
80105da0:	0f 87 ba 00 00 00    	ja     80105e60 <trap+0xf0>
80105da6:	ff 24 85 e4 80 10 80 	jmp    *-0x7fef7f1c(,%eax,4)
...
80105dba:	e8 31 dc ff ff       	call   801039f0 <myproc>
80105dbf:	85 c0                	test   %eax,%eax
80105dc1:	74 1d                	je     80105de0 <trap+0x70>
80105dc3:	e8 28 dc ff ff       	call   801039f0 <myproc>
80105dc8:	8b 50 24             	mov    0x24(%eax),%edx
80105dcb:	85 d2                	test   %edx,%edx
80105dcd:	74 11                	je     80105de0 <trap+0x70>
80105dcf:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105dd3:	83 e0 03             	and    $0x3,%eax
80105dd6:	66 83 f8 03          	cmp    $0x3,%ax
80105dda:	0f 84 30 02 00 00    	je     80106010 <trap+0x2a0>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
80105de0:	e8 0b dc ff ff       	call   801039f0 <myproc>
80105de5:	85 c0                	test   %eax,%eax
80105de7:	74 0f                	je     80105df8 <trap+0x88>
80105de9:	e8 02 dc ff ff       	call   801039f0 <myproc>
80105dee:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80105df2:	0f 84 e8 00 00 00    	je     80105ee0 <trap+0x170>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105df8:	e8 f3 db ff ff       	call   801039f0 <myproc>
80105dfd:	85 c0                	test   %eax,%eax
80105dff:	74 1d                	je     80105e1e <trap+0xae>
80105e01:	e8 ea db ff ff       	call   801039f0 <myproc>
80105e06:	8b 40 24             	mov    0x24(%eax),%eax
80105e09:	85 c0                	test   %eax,%eax
80105e0b:	74 11                	je     80105e1e <trap+0xae>
80105e0d:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105e11:	83 e0 03             	and    $0x3,%eax
80105e14:	66 83 f8 03          	cmp    $0x3,%ax
80105e18:	0f 84 3f 01 00 00    	je     80105f5d <trap+0x1ed>
...
80105e2d:	8d 76 00             	lea    0x0(%esi),%esi
  switch(tf->trapno){
80105e30:	3d 80 00 00 00       	cmp    $0x80,%eax
80105e35:	75 29                	jne    80105e60 <trap+0xf0>
    cprintf("user interrupt 128 called!\n");
80105e37:	83 ec 0c             	sub    $0xc,%esp
80105e3a:	68 26 80 10 80       	push   $0x80108026
80105e3f:	e8 5c a8 ff ff       	call   801006a0 <cprintf>
    lapiceoi();
80105e44:	e8 c7 ca ff ff       	call   80102910 <lapiceoi>
    break;
80105e49:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105e4c:	e8 9f db ff ff       	call   801039f0 <myproc>
80105e51:	85 c0                	test   %eax,%eax
80105e53:	0f 85 6a ff ff ff    	jne    80105dc3 <trap+0x53>
80105e59:	eb 85                	jmp    80105de0 <trap+0x70>
80105e5b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80105e5f:	90                   	nop
    if(myproc() == 0 || (tf->cs&3) == 0){
80105e60:	e8 8b db ff ff       	call   801039f0 <myproc>
80105e65:	8b 7b 38             	mov    0x38(%ebx),%edi
80105e68:	85 c0                	test   %eax,%eax
80105e6a:	0f 84 c8 01 00 00    	je     80106038 <trap+0x2c8>
80105e70:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105e74:	0f 84 be 01 00 00    	je     80106038 <trap+0x2c8>
...
80105e80:	e8 4b db ff ff       	call   801039d0 <cpuid>
...
80105e91:	e8 5a db ff ff       	call   801039f0 <myproc>
80105e96:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105e99:	e8 52 db ff ff       	call   801039f0 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105ec2:	e8 29 db ff ff       	call   801039f0 <myproc>
80105ec7:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105ece:	e8 1d db ff ff       	call   801039f0 <myproc>
80105ed3:	85 c0                	test   %eax,%eax
80105ed5:	0f 85 e8 fe ff ff    	jne    80105dc3 <trap+0x53>
80105edb:	e9 00 ff ff ff       	jmp    80105de0 <trap+0x70>
  if(myproc() && myproc()->state == RUNNING &&
80105ee0:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
80105ee4:	0f 85 0e ff ff ff    	jne    80105df8 <trap+0x88>
    yield();
80105eea:	e8 71 e4 ff ff       	call   80104360 <yield>
80105eef:	e9 04 ff ff ff       	jmp    80105df8 <trap+0x88>
80105ef4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105ef8:	8b 7b 38             	mov    0x38(%ebx),%edi
80105efb:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
80105eff:	e8 cc da ff ff       	call   801039d0 <cpuid>
80105f04:	57                   	push   %edi
80105f05:	56                   	push   %esi
80105f06:	50                   	push   %eax
80105f07:	68 48 80 10 80       	push   $0x80108048
80105f0c:	e8 8f a7 ff ff       	call   801006a0 <cprintf>
    lapiceoi();
80105f11:	e8 fa c9 ff ff       	call   80102910 <lapiceoi>
    break;
80105f16:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105f19:	e8 d2 da ff ff       	call   801039f0 <myproc>
80105f1e:	85 c0                	test   %eax,%eax
80105f20:	0f 85 9d fe ff ff    	jne    80105dc3 <trap+0x53>
80105f26:	e9 b5 fe ff ff       	jmp    80105de0 <trap+0x70>
80105f2b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80105f2f:	90                   	nop
    if(myproc()->killed)
80105f30:	e8 bb da ff ff       	call   801039f0 <myproc>
80105f35:	8b 70 24             	mov    0x24(%eax),%esi
80105f38:	85 f6                	test   %esi,%esi
80105f3a:	0f 85 e0 00 00 00    	jne    80106020 <trap+0x2b0>
    myproc()->tf = tf;
80105f40:	e8 ab da ff ff       	call   801039f0 <myproc>
80105f45:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105f48:	e8 33 ef ff ff       	call   80104e80 <syscall>
    if(myproc()->killed)
80105f4d:	e8 9e da ff ff       	call   801039f0 <myproc>
80105f52:	8b 48 24             	mov    0x24(%eax),%ecx
80105f55:	85 c9                	test   %ecx,%ecx
80105f57:	0f 84 c1 fe ff ff    	je     80105e1e <trap+0xae>
}
...
80105f63:	5d                   	pop    %ebp
      exit();
80105f64:	e9 97 e1 ff ff       	jmp    80104100 <exit>
...
80105f75:	e8 96 c9 ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105f7a:	e8 71 da ff ff       	call   801039f0 <myproc>
80105f7f:	85 c0                	test   %eax,%eax
80105f81:	0f 85 3c fe ff ff    	jne    80105dc3 <trap+0x53>
80105f87:	e9 54 fe ff ff       	jmp    80105de0 <trap+0x70>
80105f8c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
80105f90:	e8 3b c8 ff ff       	call   801027d0 <kbdintr>
    lapiceoi();
80105f95:	e8 76 c9 ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105f9a:	e8 51 da ff ff       	call   801039f0 <myproc>
80105f9f:	85 c0                	test   %eax,%eax
80105fa1:	0f 85 1c fe ff ff    	jne    80105dc3 <trap+0x53>
80105fa7:	e9 34 fe ff ff       	jmp    80105de0 <trap+0x70>
80105fac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){ // cpu id가 0인게 무슨 의미지?? 첫번째 cpu일때를 의미하는 듯. 근데 어차피 우린 cpu한개로 만드니까.. 항상 0!
80105fb0:	e8 1b da ff ff       	call   801039d0 <cpuid>
80105fb5:	85 c0                	test   %eax,%eax
80105fb7:	0f 85 f8 fd ff ff    	jne    80105db5 <trap+0x45>
      acquire(&tickslock);
80105fbd:	83 ec 0c             	sub    $0xc,%esp
80105fc0:	68 c0 52 11 80       	push   $0x801152c0
80105fc5:	e8 f6 e9 ff ff       	call   801049c0 <acquire>
      ticks++;
80105fca:	83 05 a0 52 11 80 01 	addl   $0x1,0x801152a0
      if (myproc() && myproc()->state == RUNNING)
80105fd1:	e8 1a da ff ff       	call   801039f0 <myproc>
80105fd6:	83 c4 10             	add    $0x10,%esp
80105fd9:	85 c0                	test   %eax,%eax
80105fdb:	74 0b                	je     80105fe8 <trap+0x278>
80105fdd:	e8 0e da ff ff       	call   801039f0 <myproc>
80105fe2:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80105fe6:	74 42                	je     8010602a <trap+0x2ba>
      wakeup(&ticks);
80105fe8:	83 ec 0c             	sub    $0xc,%esp
80105feb:	68 a0 52 11 80       	push   $0x801152a0
80105ff0:	e8 2b e5 ff ff       	call   80104520 <wakeup>
      release(&tickslock);
80105ff5:	c7 04 24 c0 52 11 80 	movl   $0x801152c0,(%esp)
80105ffc:	e8 5f e9 ff ff       	call   80104960 <release>
80106001:	83 c4 10             	add    $0x10,%esp
    lapiceoi();
80106004:	e9 ac fd ff ff       	jmp    80105db5 <trap+0x45>
80106009:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    exit();
80106010:	e8 eb e0 ff ff       	call   80104100 <exit>
80106015:	e9 c6 fd ff ff       	jmp    80105de0 <trap+0x70>
8010601a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80106020:	e8 db e0 ff ff       	call   80104100 <exit>
80106025:	e9 16 ff ff ff       	jmp    80105f40 <trap+0x1d0>
        myproc()->tq++; // 현재 프로세스의 time quantum 1 증가
8010602a:	e8 c1 d9 ff ff       	call   801039f0 <myproc>
8010602f:	83 80 80 00 00 00 01 	addl   $0x1,0x80(%eax)
80106036:	eb b0                	jmp    80105fe8 <trap+0x278>
80106038:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
8010603b:	e8 90 d9 ff ff       	call   801039d0 <cpuid>
80106040:	83 ec 0c             	sub    $0xc,%esp
80106043:	56                   	push   %esi
80106044:	57                   	push   %edi
80106045:	50                   	push   %eax
80106046:	ff 73 30             	push   0x30(%ebx)
80106049:	68 6c 80 10 80       	push   $0x8010806c
8010604e:	e8 4d a6 ff ff       	call   801006a0 <cprintf>
      panic("trap");
80106053:	83 c4 14             	add    $0x14,%esp
80106056:	68 42 80 10 80       	push   $0x80108042
8010605b:	e8 20 a3 ff ff       	call   80100380 <panic>
...
{
  if(!uart)
80106060:	a1 00 5b 11 80       	mov    0x80115b00,%eax
...
801060e7:	74 78                	je     80106161 <uartinit+0xd1>
  uart = 1;
801060e9:	c7 05 00 5b 11 80 01 	movl   $0x1,0x80115b00
801060f0:	00 00 00 
801060f3:	89 fa                	mov    %edi,%edx
...
801060fc:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
801060ff:	bf 64 81 10 80       	mov    $0x80108164,%edi
80106104:	be fd 03 00 00       	mov    $0x3fd,%esi
  ioapicenable(IRQ_COM1, 0);
80106109:	6a 00                	push   $0x0
8010610b:	6a 04                	push   $0x4
8010610d:	e8 6e c3 ff ff       	call   80102480 <ioapicenable>
  for(p="xv6...\n"; *p; p++)
80106112:	c6 45 e7 78          	movb   $0x78,-0x19(%ebp)
  ioapicenable(IRQ_COM1, 0);
80106116:	83 c4 10             	add    $0x10,%esp
80106119:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(!uart)
80106120:	a1 00 5b 11 80       	mov    0x80115b00,%eax
80106125:	bb 80 00 00 00       	mov    $0x80,%ebx
8010612a:	85 c0                	test   %eax,%eax
8010612c:	75 14                	jne    80106142 <uartinit+0xb2>
8010612e:	eb 23                	jmp    80106153 <uartinit+0xc3>
    microdelay(10);
...
80106140:	74 07                	je     80106149 <uartinit+0xb9>
80106142:	89 f2                	mov    %esi,%edx
80106144:	ec                   	in     (%dx),%al
80106145:	a8 20                	test   $0x20,%al
80106147:	74 e7                	je     80106130 <uartinit+0xa0>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106149:	0f b6 45 e7          	movzbl -0x19(%ebp),%eax
8010614d:	ba f8 03 00 00       	mov    $0x3f8,%edx
80106152:	ee                   	out    %al,(%dx)
  for(p="xv6...\n"; *p; p++)
80106153:	0f b6 47 01          	movzbl 0x1(%edi),%eax
80106157:	83 c7 01             	add    $0x1,%edi
8010615a:	88 45 e7             	mov    %al,-0x19(%ebp)
8010615d:	84 c0                	test   %al,%al
8010615f:	75 bf                	jne    80106120 <uartinit+0x90>
}
...
80106170 <uartputc>:
  if(!uart)
80106170:	a1 00 5b 11 80       	mov    0x80115b00,%eax
80106175:	85 c0                	test   %eax,%eax
80106177:	74 47                	je     801061c0 <uartputc+0x50>
{
...
80106183:	bb 80 00 00 00       	mov    $0x80,%ebx
80106188:	eb 18                	jmp    801061a2 <uartputc+0x32>
...
801061a0:	74 07                	je     801061a9 <uartputc+0x39>
801061a2:	89 f2                	mov    %esi,%edx
801061a4:	ec                   	in     (%dx),%al
801061a5:	a8 20                	test   $0x20,%al
801061a7:	74 e7                	je     80106190 <uartputc+0x20>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
801061a9:	8b 45 08             	mov    0x8(%ebp),%eax
801061ac:	ba f8 03 00 00       	mov    $0x3f8,%edx
801061b1:	ee                   	out    %al,(%dx)
}
801061b2:	8d 65 f8             	lea    -0x8(%ebp),%esp
801061b5:	5b                   	pop    %ebx
801061b6:	5e                   	pop    %esi
801061b7:	5d                   	pop    %ebp
801061b8:	c3                   	ret    
...
801061db:	e8 a0 a6 ff ff       	call   80100880 <consoleintr>
}
...
801061e7:	6a 00                	push   $0x0
  jmp alltraps
801061e9:	e9 81 fa ff ff       	jmp    80105c6f <alltraps>
...
801061f0:	6a 01                	push   $0x1
  jmp alltraps
801061f2:	e9 78 fa ff ff       	jmp    80105c6f <alltraps>
...
801061f9:	6a 02                	push   $0x2
  jmp alltraps
801061fb:	e9 6f fa ff ff       	jmp    80105c6f <alltraps>
...
80106202:	6a 03                	push   $0x3
  jmp alltraps
80106204:	e9 66 fa ff ff       	jmp    80105c6f <alltraps>
...
8010620b:	6a 04                	push   $0x4
  jmp alltraps
8010620d:	e9 5d fa ff ff       	jmp    80105c6f <alltraps>
...
80106214:	6a 05                	push   $0x5
  jmp alltraps
80106216:	e9 54 fa ff ff       	jmp    80105c6f <alltraps>
...
8010621d:	6a 06                	push   $0x6
  jmp alltraps
8010621f:	e9 4b fa ff ff       	jmp    80105c6f <alltraps>
...
80106226:	6a 07                	push   $0x7
  jmp alltraps
80106228:	e9 42 fa ff ff       	jmp    80105c6f <alltraps>
...
8010622d:	6a 08                	push   $0x8
  jmp alltraps
8010622f:	e9 3b fa ff ff       	jmp    80105c6f <alltraps>
...
80106236:	6a 09                	push   $0x9
  jmp alltraps
80106238:	e9 32 fa ff ff       	jmp    80105c6f <alltraps>
...
8010623d:	6a 0a                	push   $0xa
  jmp alltraps
8010623f:	e9 2b fa ff ff       	jmp    80105c6f <alltraps>
...
80106244:	6a 0b                	push   $0xb
  jmp alltraps
80106246:	e9 24 fa ff ff       	jmp    80105c6f <alltraps>
...
8010624b:	6a 0c                	push   $0xc
  jmp alltraps
8010624d:	e9 1d fa ff ff       	jmp    80105c6f <alltraps>
...
80106252:	6a 0d                	push   $0xd
  jmp alltraps
80106254:	e9 16 fa ff ff       	jmp    80105c6f <alltraps>
...
80106259:	6a 0e                	push   $0xe
  jmp alltraps
8010625b:	e9 0f fa ff ff       	jmp    80105c6f <alltraps>
...
80106262:	6a 0f                	push   $0xf
  jmp alltraps
80106264:	e9 06 fa ff ff       	jmp    80105c6f <alltraps>
...
8010626b:	6a 10                	push   $0x10
  jmp alltraps
8010626d:	e9 fd f9 ff ff       	jmp    80105c6f <alltraps>
...
80106272:	6a 11                	push   $0x11
  jmp alltraps
80106274:	e9 f6 f9 ff ff       	jmp    80105c6f <alltraps>
...
8010627b:	6a 12                	push   $0x12
  jmp alltraps
8010627d:	e9 ed f9 ff ff       	jmp    80105c6f <alltraps>
...
80106284:	6a 13                	push   $0x13
  jmp alltraps
80106286:	e9 e4 f9 ff ff       	jmp    80105c6f <alltraps>
...
8010628d:	6a 14                	push   $0x14
  jmp alltraps
8010628f:	e9 db f9 ff ff       	jmp    80105c6f <alltraps>
...
80106296:	6a 15                	push   $0x15
  jmp alltraps
80106298:	e9 d2 f9 ff ff       	jmp    80105c6f <alltraps>
...
8010629f:	6a 16                	push   $0x16
  jmp alltraps
801062a1:	e9 c9 f9 ff ff       	jmp    80105c6f <alltraps>
...
801062a8:	6a 17                	push   $0x17
  jmp alltraps
801062aa:	e9 c0 f9 ff ff       	jmp    80105c6f <alltraps>
...
801062b1:	6a 18                	push   $0x18
  jmp alltraps
801062b3:	e9 b7 f9 ff ff       	jmp    80105c6f <alltraps>
...
801062ba:	6a 19                	push   $0x19
  jmp alltraps
801062bc:	e9 ae f9 ff ff       	jmp    80105c6f <alltraps>
...
801062c3:	6a 1a                	push   $0x1a
  jmp alltraps
801062c5:	e9 a5 f9 ff ff       	jmp    80105c6f <alltraps>
...
801062cc:	6a 1b                	push   $0x1b
  jmp alltraps
801062ce:	e9 9c f9 ff ff       	jmp    80105c6f <alltraps>
...
801062d5:	6a 1c                	push   $0x1c
  jmp alltraps
801062d7:	e9 93 f9 ff ff       	jmp    80105c6f <alltraps>
...
801062de:	6a 1d                	push   $0x1d
  jmp alltraps
801062e0:	e9 8a f9 ff ff       	jmp    80105c6f <alltraps>
...
801062e7:	6a 1e                	push   $0x1e
  jmp alltraps
801062e9:	e9 81 f9 ff ff       	jmp    80105c6f <alltraps>
...
801062f0:	6a 1f                	push   $0x1f
  jmp alltraps
801062f2:	e9 78 f9 ff ff       	jmp    80105c6f <alltraps>
...
801062f9:	6a 20                	push   $0x20
  jmp alltraps
801062fb:	e9 6f f9 ff ff       	jmp    80105c6f <alltraps>
...
80106302:	6a 21                	push   $0x21
  jmp alltraps
80106304:	e9 66 f9 ff ff       	jmp    80105c6f <alltraps>
...
8010630b:	6a 22                	push   $0x22
  jmp alltraps
8010630d:	e9 5d f9 ff ff       	jmp    80105c6f <alltraps>
...
80106314:	6a 23                	push   $0x23
  jmp alltraps
80106316:	e9 54 f9 ff ff       	jmp    80105c6f <alltraps>
...
8010631d:	6a 24                	push   $0x24
  jmp alltraps
8010631f:	e9 4b f9 ff ff       	jmp    80105c6f <alltraps>
...
80106326:	6a 25                	push   $0x25
  jmp alltraps
80106328:	e9 42 f9 ff ff       	jmp    80105c6f <alltraps>
...
8010632f:	6a 26                	push   $0x26
  jmp alltraps
80106331:	e9 39 f9 ff ff       	jmp    80105c6f <alltraps>
...
80106338:	6a 27                	push   $0x27
  jmp alltraps
8010633a:	e9 30 f9 ff ff       	jmp    80105c6f <alltraps>
...
80106341:	6a 28                	push   $0x28
  jmp alltraps
80106343:	e9 27 f9 ff ff       	jmp    80105c6f <alltraps>
...
8010634a:	6a 29                	push   $0x29
  jmp alltraps
8010634c:	e9 1e f9 ff ff       	jmp    80105c6f <alltraps>
...
80106353:	6a 2a                	push   $0x2a
  jmp alltraps
80106355:	e9 15 f9 ff ff       	jmp    80105c6f <alltraps>
...
8010635c:	6a 2b                	push   $0x2b
  jmp alltraps
8010635e:	e9 0c f9 ff ff       	jmp    80105c6f <alltraps>
...
80106365:	6a 2c                	push   $0x2c
  jmp alltraps
80106367:	e9 03 f9 ff ff       	jmp    80105c6f <alltraps>
...
8010636e:	6a 2d                	push   $0x2d
  jmp alltraps
80106370:	e9 fa f8 ff ff       	jmp    80105c6f <alltraps>
...
80106377:	6a 2e                	push   $0x2e
  jmp alltraps
80106379:	e9 f1 f8 ff ff       	jmp    80105c6f <alltraps>
...
80106380:	6a 2f                	push   $0x2f
  jmp alltraps
80106382:	e9 e8 f8 ff ff       	jmp    80105c6f <alltraps>
...
80106389:	6a 30                	push   $0x30
  jmp alltraps
8010638b:	e9 df f8 ff ff       	jmp    80105c6f <alltraps>
...
80106392:	6a 31                	push   $0x31
  jmp alltraps
80106394:	e9 d6 f8 ff ff       	jmp    80105c6f <alltraps>
...
8010639b:	6a 32                	push   $0x32
  jmp alltraps
8010639d:	e9 cd f8 ff ff       	jmp    80105c6f <alltraps>
...
801063a4:	6a 33                	push   $0x33
  jmp alltraps
801063a6:	e9 c4 f8 ff ff       	jmp    80105c6f <alltraps>
...
801063ad:	6a 34                	push   $0x34
  jmp alltraps
801063af:	e9 bb f8 ff ff       	jmp    80105c6f <alltraps>
...
801063b6:	6a 35                	push   $0x35
  jmp alltraps
801063b8:	e9 b2 f8 ff ff       	jmp    80105c6f <alltraps>
...
801063bf:	6a 36                	push   $0x36
  jmp alltraps
801063c1:	e9 a9 f8 ff ff       	jmp    80105c6f <alltraps>
...
801063c8:	6a 37                	push   $0x37
  jmp alltraps
801063ca:	e9 a0 f8 ff ff       	jmp    80105c6f <alltraps>
...
801063d1:	6a 38                	push   $0x38
  jmp alltraps
801063d3:	e9 97 f8 ff ff       	jmp    80105c6f <alltraps>
...
801063da:	6a 39                	push   $0x39
  jmp alltraps
801063dc:	e9 8e f8 ff ff       	jmp    80105c6f <alltraps>
...
801063e3:	6a 3a                	push   $0x3a
  jmp alltraps
801063e5:	e9 85 f8 ff ff       	jmp    80105c6f <alltraps>
...
801063ec:	6a 3b                	push   $0x3b
  jmp alltraps
801063ee:	e9 7c f8 ff ff       	jmp    80105c6f <alltraps>
...
801063f5:	6a 3c                	push   $0x3c
  jmp alltraps
801063f7:	e9 73 f8 ff ff       	jmp    80105c6f <alltraps>
...
801063fe:	6a 3d                	push   $0x3d
  jmp alltraps
80106400:	e9 6a f8 ff ff       	jmp    80105c6f <alltraps>
...
80106407:	6a 3e                	push   $0x3e
  jmp alltraps
80106409:	e9 61 f8 ff ff       	jmp    80105c6f <alltraps>
...
80106410:	6a 3f                	push   $0x3f
  jmp alltraps
80106412:	e9 58 f8 ff ff       	jmp    80105c6f <alltraps>
...
80106419:	6a 40                	push   $0x40
  jmp alltraps
8010641b:	e9 4f f8 ff ff       	jmp    80105c6f <alltraps>
...
80106422:	6a 41                	push   $0x41
  jmp alltraps
80106424:	e9 46 f8 ff ff       	jmp    80105c6f <alltraps>
...
8010642b:	6a 42                	push   $0x42
  jmp alltraps
8010642d:	e9 3d f8 ff ff       	jmp    80105c6f <alltraps>
...
80106434:	6a 43                	push   $0x43
  jmp alltraps
80106436:	e9 34 f8 ff ff       	jmp    80105c6f <alltraps>
...
8010643d:	6a 44                	push   $0x44
  jmp alltraps
8010643f:	e9 2b f8 ff ff       	jmp    80105c6f <alltraps>
...
80106446:	6a 45                	push   $0x45
  jmp alltraps
80106448:	e9 22 f8 ff ff       	jmp    80105c6f <alltraps>
...
8010644f:	6a 46                	push   $0x46
  jmp alltraps
80106451:	e9 19 f8 ff ff       	jmp    80105c6f <alltraps>
...
80106458:	6a 47                	push   $0x47
  jmp alltraps
8010645a:	e9 10 f8 ff ff       	jmp    80105c6f <alltraps>
...
80106461:	6a 48                	push   $0x48
  jmp alltraps
80106463:	e9 07 f8 ff ff       	jmp    80105c6f <alltraps>
...
8010646a:	6a 49                	push   $0x49
  jmp alltraps
8010646c:	e9 fe f7 ff ff       	jmp    80105c6f <alltraps>
...
80106473:	6a 4a                	push   $0x4a
  jmp alltraps
80106475:	e9 f5 f7 ff ff       	jmp    80105c6f <alltraps>
...
8010647c:	6a 4b                	push   $0x4b
  jmp alltraps
8010647e:	e9 ec f7 ff ff       	jmp    80105c6f <alltraps>
...
80106485:	6a 4c                	push   $0x4c
  jmp alltraps
80106487:	e9 e3 f7 ff ff       	jmp    80105c6f <alltraps>
...
8010648e:	6a 4d                	push   $0x4d
  jmp alltraps
80106490:	e9 da f7 ff ff       	jmp    80105c6f <alltraps>
...
80106497:	6a 4e                	push   $0x4e
  jmp alltraps
80106499:	e9 d1 f7 ff ff       	jmp    80105c6f <alltraps>
...
801064a0:	6a 4f                	push   $0x4f
  jmp alltraps
801064a2:	e9 c8 f7 ff ff       	jmp    80105c6f <alltraps>
...
801064a9:	6a 50                	push   $0x50
  jmp alltraps
801064ab:	e9 bf f7 ff ff       	jmp    80105c6f <alltraps>
...
801064b2:	6a 51                	push   $0x51
  jmp alltraps
801064b4:	e9 b6 f7 ff ff       	jmp    80105c6f <alltraps>
...
801064bb:	6a 52                	push   $0x52
  jmp alltraps
801064bd:	e9 ad f7 ff ff       	jmp    80105c6f <alltraps>
...
801064c4:	6a 53                	push   $0x53
  jmp alltraps
801064c6:	e9 a4 f7 ff ff       	jmp    80105c6f <alltraps>
...
801064cd:	6a 54                	push   $0x54
  jmp alltraps
801064cf:	e9 9b f7 ff ff       	jmp    80105c6f <alltraps>
...
801064d6:	6a 55                	push   $0x55
  jmp alltraps
801064d8:	e9 92 f7 ff ff       	jmp    80105c6f <alltraps>
...
801064df:	6a 56                	push   $0x56
  jmp alltraps
801064e1:	e9 89 f7 ff ff       	jmp    80105c6f <alltraps>
...
801064e8:	6a 57                	push   $0x57
  jmp alltraps
801064ea:	e9 80 f7 ff ff       	jmp    80105c6f <alltraps>
...
801064f1:	6a 58                	push   $0x58
  jmp alltraps
801064f3:	e9 77 f7 ff ff       	jmp    80105c6f <alltraps>
...
801064fa:	6a 59                	push   $0x59
  jmp alltraps
801064fc:	e9 6e f7 ff ff       	jmp    80105c6f <alltraps>
...
80106503:	6a 5a                	push   $0x5a
  jmp alltraps
80106505:	e9 65 f7 ff ff       	jmp    80105c6f <alltraps>
...
8010650c:	6a 5b                	push   $0x5b
  jmp alltraps
8010650e:	e9 5c f7 ff ff       	jmp    80105c6f <alltraps>
...
80106515:	6a 5c                	push   $0x5c
  jmp alltraps
80106517:	e9 53 f7 ff ff       	jmp    80105c6f <alltraps>
...
8010651e:	6a 5d                	push   $0x5d
  jmp alltraps
80106520:	e9 4a f7 ff ff       	jmp    80105c6f <alltraps>
...
80106527:	6a 5e                	push   $0x5e
  jmp alltraps
80106529:	e9 41 f7 ff ff       	jmp    80105c6f <alltraps>
...
80106530:	6a 5f                	push   $0x5f
  jmp alltraps
80106532:	e9 38 f7 ff ff       	jmp    80105c6f <alltraps>
...
80106539:	6a 60                	push   $0x60
  jmp alltraps
8010653b:	e9 2f f7 ff ff       	jmp    80105c6f <alltraps>
...
80106542:	6a 61                	push   $0x61
  jmp alltraps
80106544:	e9 26 f7 ff ff       	jmp    80105c6f <alltraps>
...
8010654b:	6a 62                	push   $0x62
  jmp alltraps
8010654d:	e9 1d f7 ff ff       	jmp    80105c6f <alltraps>
...
80106554:	6a 63                	push   $0x63
  jmp alltraps
80106556:	e9 14 f7 ff ff       	jmp    80105c6f <alltraps>
...
8010655d:	6a 64                	push   $0x64
  jmp alltraps
8010655f:	e9 0b f7 ff ff       	jmp    80105c6f <alltraps>
...
80106566:	6a 65                	push   $0x65
  jmp alltraps
80106568:	e9 02 f7 ff ff       	jmp    80105c6f <alltraps>
...
8010656f:	6a 66                	push   $0x66
  jmp alltraps
80106571:	e9 f9 f6 ff ff       	jmp    80105c6f <alltraps>
...
80106578:	6a 67                	push   $0x67
  jmp alltraps
8010657a:	e9 f0 f6 ff ff       	jmp    80105c6f <alltraps>
...
80106581:	6a 68                	push   $0x68
  jmp alltraps
80106583:	e9 e7 f6 ff ff       	jmp    80105c6f <alltraps>
...
8010658a:	6a 69                	push   $0x69
  jmp alltraps
8010658c:	e9 de f6 ff ff       	jmp    80105c6f <alltraps>
...
80106593:	6a 6a                	push   $0x6a
  jmp alltraps
80106595:	e9 d5 f6 ff ff       	jmp    80105c6f <alltraps>
...
8010659c:	6a 6b                	push   $0x6b
  jmp alltraps
8010659e:	e9 cc f6 ff ff       	jmp    80105c6f <alltraps>
...
801065a5:	6a 6c                	push   $0x6c
  jmp alltraps
801065a7:	e9 c3 f6 ff ff       	jmp    80105c6f <alltraps>
...
801065ae:	6a 6d                	push   $0x6d
  jmp alltraps
801065b0:	e9 ba f6 ff ff       	jmp    80105c6f <alltraps>
...
801065b7:	6a 6e                	push   $0x6e
  jmp alltraps
801065b9:	e9 b1 f6 ff ff       	jmp    80105c6f <alltraps>
...
801065c0:	6a 6f                	push   $0x6f
  jmp alltraps
801065c2:	e9 a8 f6 ff ff       	jmp    80105c6f <alltraps>
...
801065c9:	6a 70                	push   $0x70
  jmp alltraps
801065cb:	e9 9f f6 ff ff       	jmp    80105c6f <alltraps>
...
801065d2:	6a 71                	push   $0x71
  jmp alltraps
801065d4:	e9 96 f6 ff ff       	jmp    80105c6f <alltraps>
...
801065db:	6a 72                	push   $0x72
  jmp alltraps
801065dd:	e9 8d f6 ff ff       	jmp    80105c6f <alltraps>
...
801065e4:	6a 73                	push   $0x73
  jmp alltraps
801065e6:	e9 84 f6 ff ff       	jmp    80105c6f <alltraps>
...
801065ed:	6a 74                	push   $0x74
  jmp alltraps
801065ef:	e9 7b f6 ff ff       	jmp    80105c6f <alltraps>
...
801065f6:	6a 75                	push   $0x75
  jmp alltraps
801065f8:	e9 72 f6 ff ff       	jmp    80105c6f <alltraps>
...
801065ff:	6a 76                	push   $0x76
  jmp alltraps
80106601:	e9 69 f6 ff ff       	jmp    80105c6f <alltraps>
...
80106608:	6a 77                	push   $0x77
  jmp alltraps
8010660a:	e9 60 f6 ff ff       	jmp    80105c6f <alltraps>
...
80106611:	6a 78                	push   $0x78
  jmp alltraps
80106613:	e9 57 f6 ff ff       	jmp    80105c6f <alltraps>
...
8010661a:	6a 79                	push   $0x79
  jmp alltraps
8010661c:	e9 4e f6 ff ff       	jmp    80105c6f <alltraps>
...
80106623:	6a 7a                	push   $0x7a
  jmp alltraps
80106625:	e9 45 f6 ff ff       	jmp    80105c6f <alltraps>
...
8010662c:	6a 7b                	push   $0x7b
  jmp alltraps
8010662e:	e9 3c f6 ff ff       	jmp    80105c6f <alltraps>
...
80106635:	6a 7c                	push   $0x7c
  jmp alltraps
80106637:	e9 33 f6 ff ff       	jmp    80105c6f <alltraps>
...
8010663e:	6a 7d                	push   $0x7d
  jmp alltraps
80106640:	e9 2a f6 ff ff       	jmp    80105c6f <alltraps>
...
80106647:	6a 7e                	push   $0x7e
  jmp alltraps
80106649:	e9 21 f6 ff ff       	jmp    80105c6f <alltraps>
...
80106650:	6a 7f                	push   $0x7f
  jmp alltraps
80106652:	e9 18 f6 ff ff       	jmp    80105c6f <alltraps>
...
80106659:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010665e:	e9 0c f6 ff ff       	jmp    80105c6f <alltraps>
...
80106665:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010666a:	e9 00 f6 ff ff       	jmp    80105c6f <alltraps>
...
80106671:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106676:	e9 f4 f5 ff ff       	jmp    80105c6f <alltraps>
...
8010667d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106682:	e9 e8 f5 ff ff       	jmp    80105c6f <alltraps>
...
80106689:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010668e:	e9 dc f5 ff ff       	jmp    80105c6f <alltraps>
...
80106695:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010669a:	e9 d0 f5 ff ff       	jmp    80105c6f <alltraps>
...
801066a1:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801066a6:	e9 c4 f5 ff ff       	jmp    80105c6f <alltraps>
...
801066ad:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801066b2:	e9 b8 f5 ff ff       	jmp    80105c6f <alltraps>
...
801066b9:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801066be:	e9 ac f5 ff ff       	jmp    80105c6f <alltraps>
...
801066c5:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801066ca:	e9 a0 f5 ff ff       	jmp    80105c6f <alltraps>
...
801066d1:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801066d6:	e9 94 f5 ff ff       	jmp    80105c6f <alltraps>
...
801066dd:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801066e2:	e9 88 f5 ff ff       	jmp    80105c6f <alltraps>
...
801066e9:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801066ee:	e9 7c f5 ff ff       	jmp    80105c6f <alltraps>
...
801066f5:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801066fa:	e9 70 f5 ff ff       	jmp    80105c6f <alltraps>
...
80106701:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106706:	e9 64 f5 ff ff       	jmp    80105c6f <alltraps>
...
8010670d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106712:	e9 58 f5 ff ff       	jmp    80105c6f <alltraps>
...
80106719:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010671e:	e9 4c f5 ff ff       	jmp    80105c6f <alltraps>
...
80106725:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010672a:	e9 40 f5 ff ff       	jmp    80105c6f <alltraps>
...
80106731:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106736:	e9 34 f5 ff ff       	jmp    80105c6f <alltraps>
...
8010673d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106742:	e9 28 f5 ff ff       	jmp    80105c6f <alltraps>
...
80106749:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010674e:	e9 1c f5 ff ff       	jmp    80105c6f <alltraps>
...
80106755:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010675a:	e9 10 f5 ff ff       	jmp    80105c6f <alltraps>
...
80106761:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106766:	e9 04 f5 ff ff       	jmp    80105c6f <alltraps>
...
8010676d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106772:	e9 f8 f4 ff ff       	jmp    80105c6f <alltraps>
...
80106779:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010677e:	e9 ec f4 ff ff       	jmp    80105c6f <alltraps>
...
80106785:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010678a:	e9 e0 f4 ff ff       	jmp    80105c6f <alltraps>
...
80106791:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106796:	e9 d4 f4 ff ff       	jmp    80105c6f <alltraps>
...
8010679d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801067a2:	e9 c8 f4 ff ff       	jmp    80105c6f <alltraps>
...
801067a9:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801067ae:	e9 bc f4 ff ff       	jmp    80105c6f <alltraps>
...
801067b5:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801067ba:	e9 b0 f4 ff ff       	jmp    80105c6f <alltraps>
...
801067c1:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801067c6:	e9 a4 f4 ff ff       	jmp    80105c6f <alltraps>
...
801067cd:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801067d2:	e9 98 f4 ff ff       	jmp    80105c6f <alltraps>
...
801067d9:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801067de:	e9 8c f4 ff ff       	jmp    80105c6f <alltraps>
...
801067e5:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801067ea:	e9 80 f4 ff ff       	jmp    80105c6f <alltraps>
...
801067f1:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801067f6:	e9 74 f4 ff ff       	jmp    80105c6f <alltraps>
...
801067fd:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106802:	e9 68 f4 ff ff       	jmp    80105c6f <alltraps>
...
80106809:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010680e:	e9 5c f4 ff ff       	jmp    80105c6f <alltraps>
...
80106815:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010681a:	e9 50 f4 ff ff       	jmp    80105c6f <alltraps>
...
80106821:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106826:	e9 44 f4 ff ff       	jmp    80105c6f <alltraps>
...
8010682d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106832:	e9 38 f4 ff ff       	jmp    80105c6f <alltraps>
...
80106839:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010683e:	e9 2c f4 ff ff       	jmp    80105c6f <alltraps>
...
80106845:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010684a:	e9 20 f4 ff ff       	jmp    80105c6f <alltraps>
...
80106851:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106856:	e9 14 f4 ff ff       	jmp    80105c6f <alltraps>
...
8010685d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106862:	e9 08 f4 ff ff       	jmp    80105c6f <alltraps>
...
80106869:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010686e:	e9 fc f3 ff ff       	jmp    80105c6f <alltraps>
...
80106875:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010687a:	e9 f0 f3 ff ff       	jmp    80105c6f <alltraps>
...
80106881:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106886:	e9 e4 f3 ff ff       	jmp    80105c6f <alltraps>
...
8010688d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106892:	e9 d8 f3 ff ff       	jmp    80105c6f <alltraps>
...
80106899:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010689e:	e9 cc f3 ff ff       	jmp    80105c6f <alltraps>
...
801068a5:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801068aa:	e9 c0 f3 ff ff       	jmp    80105c6f <alltraps>
...
801068b1:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801068b6:	e9 b4 f3 ff ff       	jmp    80105c6f <alltraps>
...
801068bd:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801068c2:	e9 a8 f3 ff ff       	jmp    80105c6f <alltraps>
...
801068c9:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801068ce:	e9 9c f3 ff ff       	jmp    80105c6f <alltraps>
...
801068d5:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801068da:	e9 90 f3 ff ff       	jmp    80105c6f <alltraps>
...
801068e1:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801068e6:	e9 84 f3 ff ff       	jmp    80105c6f <alltraps>
...
801068ed:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801068f2:	e9 78 f3 ff ff       	jmp    80105c6f <alltraps>
...
801068f9:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801068fe:	e9 6c f3 ff ff       	jmp    80105c6f <alltraps>
...
80106905:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010690a:	e9 60 f3 ff ff       	jmp    80105c6f <alltraps>
...
80106911:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106916:	e9 54 f3 ff ff       	jmp    80105c6f <alltraps>
...
8010691d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106922:	e9 48 f3 ff ff       	jmp    80105c6f <alltraps>
...
80106929:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010692e:	e9 3c f3 ff ff       	jmp    80105c6f <alltraps>
...
80106935:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010693a:	e9 30 f3 ff ff       	jmp    80105c6f <alltraps>
...
80106941:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106946:	e9 24 f3 ff ff       	jmp    80105c6f <alltraps>
...
8010694d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106952:	e9 18 f3 ff ff       	jmp    80105c6f <alltraps>
...
80106959:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010695e:	e9 0c f3 ff ff       	jmp    80105c6f <alltraps>
...
80106965:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010696a:	e9 00 f3 ff ff       	jmp    80105c6f <alltraps>
...
80106971:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106976:	e9 f4 f2 ff ff       	jmp    80105c6f <alltraps>
...
8010697d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106982:	e9 e8 f2 ff ff       	jmp    80105c6f <alltraps>
...
80106989:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010698e:	e9 dc f2 ff ff       	jmp    80105c6f <alltraps>
...
80106995:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010699a:	e9 d0 f2 ff ff       	jmp    80105c6f <alltraps>
...
801069a1:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801069a6:	e9 c4 f2 ff ff       	jmp    80105c6f <alltraps>
...
801069ad:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801069b2:	e9 b8 f2 ff ff       	jmp    80105c6f <alltraps>
...
801069b9:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801069be:	e9 ac f2 ff ff       	jmp    80105c6f <alltraps>
...
801069c5:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801069ca:	e9 a0 f2 ff ff       	jmp    80105c6f <alltraps>
...
801069d1:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801069d6:	e9 94 f2 ff ff       	jmp    80105c6f <alltraps>
...
801069dd:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801069e2:	e9 88 f2 ff ff       	jmp    80105c6f <alltraps>
...
801069e9:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801069ee:	e9 7c f2 ff ff       	jmp    80105c6f <alltraps>
...
801069f5:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801069fa:	e9 70 f2 ff ff       	jmp    80105c6f <alltraps>
...
80106a01:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106a06:	e9 64 f2 ff ff       	jmp    80105c6f <alltraps>
...
80106a0d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106a12:	e9 58 f2 ff ff       	jmp    80105c6f <alltraps>
...
80106a19:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80106a1e:	e9 4c f2 ff ff       	jmp    80105c6f <alltraps>
...
80106a25:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80106a2a:	e9 40 f2 ff ff       	jmp    80105c6f <alltraps>
...
80106a31:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106a36:	e9 34 f2 ff ff       	jmp    80105c6f <alltraps>
...
80106a3d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106a42:	e9 28 f2 ff ff       	jmp    80105c6f <alltraps>
...
80106a49:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80106a4e:	e9 1c f2 ff ff       	jmp    80105c6f <alltraps>
...
80106a55:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80106a5a:	e9 10 f2 ff ff       	jmp    80105c6f <alltraps>
...
80106a61:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106a66:	e9 04 f2 ff ff       	jmp    80105c6f <alltraps>
...
80106a6d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106a72:	e9 f8 f1 ff ff       	jmp    80105c6f <alltraps>
...
80106a79:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80106a7e:	e9 ec f1 ff ff       	jmp    80105c6f <alltraps>
...
80106a85:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80106a8a:	e9 e0 f1 ff ff       	jmp    80105c6f <alltraps>
...
80106a91:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106a96:	e9 d4 f1 ff ff       	jmp    80105c6f <alltraps>
...
80106a9d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106aa2:	e9 c8 f1 ff ff       	jmp    80105c6f <alltraps>
...
80106aa9:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80106aae:	e9 bc f1 ff ff       	jmp    80105c6f <alltraps>
...
80106ab5:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80106aba:	e9 b0 f1 ff ff       	jmp    80105c6f <alltraps>
...
80106ac1:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106ac6:	e9 a4 f1 ff ff       	jmp    80105c6f <alltraps>
...
80106acd:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106ad2:	e9 98 f1 ff ff       	jmp    80105c6f <alltraps>
...
80106ad9:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80106ade:	e9 8c f1 ff ff       	jmp    80105c6f <alltraps>
...
80106ae5:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80106aea:	e9 80 f1 ff ff       	jmp    80105c6f <alltraps>
...
80106af1:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106af6:	e9 74 f1 ff ff       	jmp    80105c6f <alltraps>
...
80106afd:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106b02:	e9 68 f1 ff ff       	jmp    80105c6f <alltraps>
...
80106b09:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80106b0e:	e9 5c f1 ff ff       	jmp    80105c6f <alltraps>
...
80106b15:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80106b1a:	e9 50 f1 ff ff       	jmp    80105c6f <alltraps>
...
80106b21:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106b26:	e9 44 f1 ff ff       	jmp    80105c6f <alltraps>
...
80106b2d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106b32:	e9 38 f1 ff ff       	jmp    80105c6f <alltraps>
...
80106b39:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80106b3e:	e9 2c f1 ff ff       	jmp    80105c6f <alltraps>
...
80106b45:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80106b4a:	e9 20 f1 ff ff       	jmp    80105c6f <alltraps>
...
80106b51:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106b56:	e9 14 f1 ff ff       	jmp    80105c6f <alltraps>
...
80106b5d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106b62:	e9 08 f1 ff ff       	jmp    80105c6f <alltraps>
...
80106b69:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80106b6e:	e9 fc f0 ff ff       	jmp    80105c6f <alltraps>
...
80106b75:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106b7a:	e9 f0 f0 ff ff       	jmp    80105c6f <alltraps>
...
80106b81:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106b86:	e9 e4 f0 ff ff       	jmp    80105c6f <alltraps>
...
80106b8d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106b92:	e9 d8 f0 ff ff       	jmp    80105c6f <alltraps>
...
80106b99:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80106b9e:	e9 cc f0 ff ff       	jmp    80105c6f <alltraps>
...
80106ba5:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106baa:	e9 c0 f0 ff ff       	jmp    80105c6f <alltraps>
...
80106bb1:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106bb6:	e9 b4 f0 ff ff       	jmp    80105c6f <alltraps>
...
80106bbd:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106bc2:	e9 a8 f0 ff ff       	jmp    80105c6f <alltraps>
...
80106bc9:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80106bce:	e9 9c f0 ff ff       	jmp    80105c6f <alltraps>
...
80106bd5:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106bda:	e9 90 f0 ff ff       	jmp    80105c6f <alltraps>
...
80106be1:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106be6:	e9 84 f0 ff ff       	jmp    80105c6f <alltraps>
...
80106bed:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106bf2:	e9 78 f0 ff ff       	jmp    80105c6f <alltraps>
...
80106bf9:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80106bfe:	e9 6c f0 ff ff       	jmp    80105c6f <alltraps>
...
80106c05:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80106c0a:	e9 60 f0 ff ff       	jmp    80105c6f <alltraps>
...
80106c11:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106c16:	e9 54 f0 ff ff       	jmp    80105c6f <alltraps>
...
80106c1d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106c22:	e9 48 f0 ff ff       	jmp    80105c6f <alltraps>
...
80106c29:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80106c2e:	e9 3c f0 ff ff       	jmp    80105c6f <alltraps>
...
80106c35:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106c3a:	e9 30 f0 ff ff       	jmp    80105c6f <alltraps>
...
80106c41:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106c46:	e9 24 f0 ff ff       	jmp    80105c6f <alltraps>
...
80106c4d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106c52:	e9 18 f0 ff ff       	jmp    80105c6f <alltraps>
...
80106c65:	53                   	push   %ebx
  ...
  a = PGROUNDUP(newsz);
80106c66:	8d 99 ff 0f 00 00    	lea    0xfff(%ecx),%ebx
80106c6c:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
80106c72:	83 ec 1c             	sub    $0x1c,%esp
80106c75:	89 4d e0             	mov    %ecx,-0x20(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80106c78:	39 d3                	cmp    %edx,%ebx
80106c7a:	73 49                	jae    80106cc5 <deallocuvm.part.0+0x65>
80106c7c:	89 c7                	mov    %eax,%edi
80106c7e:	eb 0c                	jmp    80106c8c <deallocuvm.part.0+0x2c>
    pte = walkpgdir(pgdir, (char*)a, 0);
    if(!pte)
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
80106c80:	83 c0 01             	add    $0x1,%eax
80106c83:	c1 e0 16             	shl    $0x16,%eax
80106c86:	89 c3                	mov    %eax,%ebx
  for(; a  < oldsz; a += PGSIZE){
80106c88:	39 da                	cmp    %ebx,%edx
80106c8a:	76 39                	jbe    80106cc5 <deallocuvm.part.0+0x65>
  pde = &pgdir[PDX(va)];
80106c8c:	89 d8                	mov    %ebx,%eax
80106c8e:	c1 e8 16             	shr    $0x16,%eax
  if(*pde & PTE_P){
80106c91:	8b 0c 87             	mov    (%edi,%eax,4),%ecx
80106c94:	f6 c1 01             	test   $0x1,%cl
80106c97:	74 e7                	je     80106c80 <deallocuvm.part.0+0x20>
  return &pgtab[PTX(va)];
80106c99:	89 de                	mov    %ebx,%esi
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80106c9b:	81 e1 00 f0 ff ff    	and    $0xfffff000,%ecx
  return &pgtab[PTX(va)];
80106ca1:	c1 ee 0a             	shr    $0xa,%esi
80106ca4:	81 e6 fc 0f 00 00    	and    $0xffc,%esi
80106caa:	8d b4 31 00 00 00 80 	lea    -0x80000000(%ecx,%esi,1),%esi
    if(!pte)
80106cb1:	85 f6                	test   %esi,%esi
80106cb3:	74 cb                	je     80106c80 <deallocuvm.part.0+0x20>
    else if((*pte & PTE_P) != 0){
80106cb5:	8b 06                	mov    (%esi),%eax
80106cb7:	a8 01                	test   $0x1,%al
80106cb9:	75 15                	jne    80106cd0 <deallocuvm.part.0+0x70>
  for(; a  < oldsz; a += PGSIZE){
80106cbb:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106cc1:	39 da                	cmp    %ebx,%edx
80106cc3:	77 c7                	ja     80106c8c <deallocuvm.part.0+0x2c>
      kfree(v);
      *pte = 0;
    }
  }
...
80106cc5:	8b 45 e0             	mov    -0x20(%ebp),%eax
...
80106cd5:	74 25                	je     80106cfc <deallocuvm.part.0+0x9c>
      kfree(v);
80106cd7:	83 ec 0c             	sub    $0xc,%esp
      char *v = P2V(pa);
80106cda:	05 00 00 00 80       	add    $0x80000000,%eax
80106cdf:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80106ce2:	81 c3 00 10 00 00    	add    $0x1000,%ebx
      kfree(v);
80106ce8:	50                   	push   %eax
80106ce9:	e8 d2 b7 ff ff       	call   801024c0 <kfree>
      *pte = 0;
80106cee:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
  for(; a  < oldsz; a += PGSIZE){
80106cf4:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106cf7:	83 c4 10             	add    $0x10,%esp
80106cfa:	eb 8c                	jmp    80106c88 <deallocuvm.part.0+0x28>
        panic("kfree");
80106cfc:	83 ec 0c             	sub    $0xc,%esp
80106cff:	68 46 7a 10 80       	push   $0x80107a46
...
80106d35:	89 45 e0             	mov    %eax,-0x20(%ebp)
80106d38:	eb 3d                	jmp    80106d77 <mappages+0x67>
...
80106d6a:	89 30                	mov    %esi,(%eax)
    if(a == last)
80106d6c:	3b 5d dc             	cmp    -0x24(%ebp),%ebx
80106d6f:	74 6f                	je     80106de0 <mappages+0xd0>
    a += PGSIZE;
80106d71:	81 c3 00 10 00 00    	add    $0x1000,%ebx
  for(;;){
80106d77:	8b 45 e0             	mov    -0x20(%ebp),%eax
  pde = &pgdir[PDX(va)];
80106d7a:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80106d7d:	8d 34 18             	lea    (%eax,%ebx,1),%esi
80106d80:	89 d8                	mov    %ebx,%eax
80106d82:	c1 e8 16             	shr    $0x16,%eax
80106d85:	8d 3c 81             	lea    (%ecx,%eax,4),%edi
  if(*pde & PTE_P){
80106d88:	8b 07                	mov    (%edi),%eax
80106d8a:	a8 01                	test   $0x1,%al
80106d8c:	75 b2                	jne    80106d40 <mappages+0x30>
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
80106d8e:	e8 ed b8 ff ff       	call   80102680 <kalloc>
80106d93:	85 c0                	test   %eax,%eax
80106d95:	74 39                	je     80106dd0 <mappages+0xc0>
    memset(pgtab, 0, PGSIZE);
80106d97:	83 ec 04             	sub    $0x4,%esp
80106d9a:	89 45 d8             	mov    %eax,-0x28(%ebp)
80106d9d:	68 00 10 00 00       	push   $0x1000
80106da2:	6a 00                	push   $0x0
80106da4:	50                   	push   %eax
80106da5:	e8 d6 dc ff ff       	call   80104a80 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80106daa:	8b 55 d8             	mov    -0x28(%ebp),%edx
  return &pgtab[PTX(va)];
80106dad:	83 c4 10             	add    $0x10,%esp
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80106db0:	8d 82 00 00 00 80    	lea    -0x80000000(%edx),%eax
80106db6:	83 c8 07             	or     $0x7,%eax
80106db9:	89 07                	mov    %eax,(%edi)
  return &pgtab[PTX(va)];
80106dbb:	89 d8                	mov    %ebx,%eax
80106dbd:	c1 e8 0a             	shr    $0xa,%eax
80106dc0:	25 fc 0f 00 00       	and    $0xffc,%eax
80106dc5:	01 d0                	add    %edx,%eax
80106dc7:	eb 92                	jmp    80106d5b <mappages+0x4b>
...
80106ded:	68 6c 81 10 80       	push   $0x8010816c
80106df2:	e8 89 95 ff ff       	call   80100380 <panic>
...
80106e03:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106e06:	e8 c5 cb ff ff       	call   801039d0 <cpuid>
  pd[0] = size-1;
...
80106e1a:	c7 80 18 28 11 80 ff 	movl   $0xffff,-0x7feed7e8(%eax)
80106e21:	ff 00 00 
80106e24:	c7 80 1c 28 11 80 00 	movl   $0xcf9a00,-0x7feed7e4(%eax)
80106e2b:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106e2e:	c7 80 20 28 11 80 ff 	movl   $0xffff,-0x7feed7e0(%eax)
80106e35:	ff 00 00 
80106e38:	c7 80 24 28 11 80 00 	movl   $0xcf9200,-0x7feed7dc(%eax)
80106e3f:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106e42:	c7 80 28 28 11 80 ff 	movl   $0xffff,-0x7feed7d8(%eax)
80106e49:	ff 00 00 
80106e4c:	c7 80 2c 28 11 80 00 	movl   $0xcffa00,-0x7feed7d4(%eax)
80106e53:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106e56:	c7 80 30 28 11 80 ff 	movl   $0xffff,-0x7feed7d0(%eax)
80106e5d:	ff 00 00 
80106e60:	c7 80 34 28 11 80 00 	movl   $0xcff200,-0x7feed7cc(%eax)
80106e67:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
80106e6a:	05 10 28 11 80       	add    $0x80112810,%eax
  pd[1] = (uint)p;
...
80106e90:	a1 04 5b 11 80       	mov    0x80115b04,%eax
...
80106eae:	0f 84 cb 00 00 00    	je     80106f7f <switchuvm+0xdf>
  if(p->kstack == 0)
80106eb4:	8b 46 08             	mov    0x8(%esi),%eax
80106eb7:	85 c0                	test   %eax,%eax
80106eb9:	0f 84 da 00 00 00    	je     80106f99 <switchuvm+0xf9>
  if(p->pgdir == 0)
80106ebf:	8b 46 04             	mov    0x4(%esi),%eax
80106ec2:	85 c0                	test   %eax,%eax
80106ec4:	0f 84 c2 00 00 00    	je     80106f8c <switchuvm+0xec>
  pushcli();
80106eca:	e8 a1 d9 ff ff       	call   80104870 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106ecf:	e8 9c ca ff ff       	call   80103970 <mycpu>
80106ed4:	89 c3                	mov    %eax,%ebx
80106ed6:	e8 95 ca ff ff       	call   80103970 <mycpu>
80106edb:	89 c7                	mov    %eax,%edi
80106edd:	e8 8e ca ff ff       	call   80103970 <mycpu>
80106ee2:	83 c7 08             	add    $0x8,%edi
80106ee5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106ee8:	e8 83 ca ff ff       	call   80103970 <mycpu>
...
80106fcb:	77 4b                	ja     80107018 <inituvm+0x68>
  mem = kalloc();
80106fcd:	e8 ae b6 ff ff       	call   80102680 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106fdf:	e8 9c da ff ff       	call   80104a80 <memset>
...
80106ff8:	e8 13 fd ff ff       	call   80106d10 <mappages>
  memmove(mem, init, sz);
...
80107012:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80107013:	e9 08 db ff ff       	jmp    80104b20 <memmove>
    panic("inituvm: more than a page");
80107018:	83 ec 0c             	sub    $0xc,%esp
8010701b:	68 b1 81 10 80       	push   $0x801081b1
...
80107080:	68 cb 81 10 80       	push   $0x801081cb
...
80107108:	68 6c 82 10 80       	push   $0x8010826c
...
8010716b:	e8 10 d9 ff ff       	call   80104a80 <memset>
...
80107184:	e8 87 fb ff ff       	call   80106d10 <mappages>
...
80107199:	76 48                	jbe    801071e3 <allocuvm+0xc3>
    mem = kalloc();
8010719b:	e8 e0 b4 ff ff       	call   80102680 <kalloc>
...
801071a9:	68 e9 81 10 80       	push   $0x801081e9
...
801071c5:	e8 96 fa ff ff       	call   80106c60 <deallocuvm.part.0>
      return 0;
...
8010720b:	68 01 82 10 80       	push   $0x80108201
...
80107227:	e8 34 fa ff ff       	call   80106c60 <deallocuvm.part.0>
      kfree(mem);
8010722c:	83 ec 0c             	sub    $0xc,%esp
8010722f:	53                   	push   %ebx
80107230:	e8 8b b2 ff ff       	call   801024c0 <kfree>
      return 0;
...
80107260:	5d                   	pop    %ebp
80107261:	e9 fa f9 ff ff       	jmp    80106c60 <deallocuvm.part.0>
...
8010729b:	e8 c0 f9 ff ff       	call   80106c60 <deallocuvm.part.0>
...
801072ce:	e8 ed b1 ff ff       	call   801024c0 <kfree>
...
801072e3:	5d                   	pop    %ebp
  kfree((char*)pgdir);
801072e4:	e9 d7 b1 ff ff       	jmp    801024c0 <kfree>
    panic("freevm: no pgdir");
801072e9:	83 ec 0c             	sub    $0xc,%esp
801072ec:	68 1d 82 10 80       	push   $0x8010821d
...
80107320:	e8 5b d7 ff ff       	call   80104a80 <memset>
...
8010733b:	e8 d0 f9 ff ff       	call   80106d10 <mappages>
...
8010738b:	a3 04 5b 11 80       	mov    %eax,0x80115b04
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
801073bc:	68 2e 82 10 80       	push   $0x8010822e
...
80107403:	0f 84 bd 00 00 00    	je     801074c6 <copyuvm+0xd6>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
...
80107432:	68 38 82 10 80       	push   $0x80108238
...
8010746f:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80107475:	e8 06 b2 ff ff       	call   80102680 <kalloc>
...
80107490:	e8 8b d6 ff ff       	call   80104b20 <memmove>
...
801074ab:	e8 60 f8 ff ff       	call   80106d10 <mappages>
...
801074bd:	39 75 0c             	cmp    %esi,0xc(%ebp)
801074c0:	0f 87 5a ff ff ff    	ja     80107420 <copyuvm+0x30>
  return d;
...
801074dc:	e8 df af ff ff       	call   801024c0 <kfree>
      goto bad;
...
80107507:	68 52 82 10 80       	push   $0x80108252
...
801075c0:	e8 5b d5 ff ff       	call   80104b20 <memmove>
    len -= n;
    buf += n;
...
80107653:	83 ec 10             	sub    $0x10,%esp
	cprintf("%s\n",str);
80107656:	ff 75 08             	push   0x8(%ebp)
80107659:	68 8f 82 10 80       	push   $0x8010828f
8010765e:	e8 3d 90 ff ff       	call   801006a0 <cprintf>
	return 0xABCDABCD;
}
80107663:	b8 cd ab cd ab       	mov    $0xabcdabcd,%eax
80107668:	c9                   	leave  
80107669:	c3                   	ret    
8010766a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

80107670 <sys_myfunction>:
...
80107673:	83 ec 20             	sub    $0x20,%esp
char *str;
//Decode argument using argstr
if (argstr(0, &str) < 0)
80107676:	8d 45 f4             	lea    -0xc(%ebp),%eax
80107679:	50                   	push   %eax
8010767a:	6a 00                	push   $0x0
8010767c:	e8 7f d7 ff ff       	call   80104e00 <argstr>
80107681:	83 c4 10             	add    $0x10,%esp
80107684:	89 c2                	mov    %eax,%edx
80107686:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010768b:	85 d2                	test   %edx,%edx
8010768d:	78 18                	js     801076a7 <sys_myfunction+0x37>
	cprintf("%s\n",str);
8010768f:	83 ec 08             	sub    $0x8,%esp
80107692:	ff 75 f4             	push   -0xc(%ebp)
80107695:	68 8f 82 10 80       	push   $0x8010828f
8010769a:	e8 01 90 ff ff       	call   801006a0 <cprintf>
	return -1;
return myfunction(str);
8010769f:	83 c4 10             	add    $0x10,%esp
801076a2:	b8 cd ab cd ab       	mov    $0xabcdabcd,%eax
}
801076a7:	c9                   	leave  
801076a8:	c3                   	ret    
...
801076b3:	8b 55 08             	mov    0x8(%ebp),%edx
    queue->front = 0;
801076b6:	c7 02 00 00 00 00    	movl   $0x0,(%edx)
    queue->rear = 0;
801076bc:	8d 42 0c             	lea    0xc(%edx),%eax
801076bf:	81 c2 10 01 00 00    	add    $0x110,%edx
801076c5:	c7 82 f4 fe ff ff 00 	movl   $0x0,-0x10c(%edx)
801076cc:	00 00 00 
    queue->count = 0;
801076cf:	c7 82 f8 fe ff ff 00 	movl   $0x0,-0x108(%edx)
801076d6:	00 00 00 
    for(int i = 0; i < NPROC + 1; i++){
801076d9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        queue->q[i] = NULL; // pointer 모두 NULL로 초기화
801076e0:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    for(int i = 0; i < NPROC + 1; i++){
801076e6:	83 c0 04             	add    $0x4,%eax
801076e9:	39 d0                	cmp    %edx,%eax
801076eb:	75 f3                	jne    801076e0 <initQueue+0x30>
    }
}
801076ed:	5d                   	pop    %ebp
801076ee:	c3                   	ret    
...
801076f6:	5d                   	pop    %ebp
    if (queue->front == queue->rear)
801076f7:	8b 50 04             	mov    0x4(%eax),%edx
801076fa:	39 10                	cmp    %edx,(%eax)
801076fc:	0f 94 c0             	sete   %al
801076ff:	0f b6 c0             	movzbl %al,%eax
}
80107702:	c3                   	ret    
...
80107711:	ba 7f e0 07 7e       	mov    $0x7e07e07f,%edx
{
80107716:	89 e5                	mov    %esp,%ebp
80107718:	53                   	push   %ebx
80107719:	8b 5d 08             	mov    0x8(%ebp),%ebx
    if ((queue->rear + 1) % (NPROC + 1) == queue->front)
8010771c:	8b 43 04             	mov    0x4(%ebx),%eax
8010771f:	8d 48 01             	lea    0x1(%eax),%ecx
80107722:	89 c8                	mov    %ecx,%eax
80107724:	f7 ea                	imul   %edx
80107726:	89 c8                	mov    %ecx,%eax
80107728:	c1 f8 1f             	sar    $0x1f,%eax
8010772b:	c1 fa 05             	sar    $0x5,%edx
8010772e:	29 c2                	sub    %eax,%edx
80107730:	89 d0                	mov    %edx,%eax
80107732:	c1 e0 06             	shl    $0x6,%eax
80107735:	01 d0                	add    %edx,%eax
80107737:	29 c1                	sub    %eax,%ecx
80107739:	31 c0                	xor    %eax,%eax
8010773b:	3b 0b                	cmp    (%ebx),%ecx
        return 1;
    return 0;
}
8010773d:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80107740:	c9                   	leave  
    if ((queue->rear + 1) % (NPROC + 1) == queue->front)
80107741:	0f 94 c0             	sete   %al
}
80107744:	c3                   	ret    
80107745:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
80107751:	ba 7f e0 07 7e       	mov    $0x7e07e07f,%edx
{
80107756:	89 e5                	mov    %esp,%ebp
80107758:	53                   	push   %ebx
80107759:	8b 4d 08             	mov    0x8(%ebp),%ecx
    queue->rear = (queue->rear + 1) % (NPROC + 1);
8010775c:	8b 41 04             	mov    0x4(%ecx),%eax
8010775f:	8d 58 01             	lea    0x1(%eax),%ebx
80107762:	89 d8                	mov    %ebx,%eax
80107764:	f7 ea                	imul   %edx
80107766:	89 d8                	mov    %ebx,%eax
80107768:	c1 f8 1f             	sar    $0x1f,%eax
8010776b:	c1 fa 05             	sar    $0x5,%edx
8010776e:	29 c2                	sub    %eax,%edx
80107770:	89 d0                	mov    %edx,%eax
80107772:	c1 e0 06             	shl    $0x6,%eax
80107775:	01 d0                	add    %edx,%eax
80107777:	29 c3                	sub    %eax,%ebx
    queue->q[queue->rear] = p;
80107779:	8b 45 0c             	mov    0xc(%ebp),%eax
    queue->rear = (queue->rear + 1) % (NPROC + 1);
8010777c:	89 59 04             	mov    %ebx,0x4(%ecx)
    queue->q[queue->rear] = p;
8010777f:	89 44 99 0c          	mov    %eax,0xc(%ecx,%ebx,4)
    queue->count++;
80107783:	83 41 08 01          	addl   $0x1,0x8(%ecx)
#ifdef DEBUG
  cprintf("[%d] mlfq enqueue\n", p->pid);
#endif
}
80107787:	8b 5d fc             	mov    -0x4(%ebp),%ebx
8010778a:	c9                   	leave  
8010778b:	c3                   	ret    
...
80107791:	31 c0                	xor    %eax,%eax
80107793:	89 e5                	mov    %esp,%ebp
80107795:	53                   	push   %ebx
80107796:	8b 4d 08             	mov    0x8(%ebp),%ecx
    if (queue->front == queue->rear)
80107799:	8b 19                	mov    (%ecx),%ebx
8010779b:	3b 59 04             	cmp    0x4(%ecx),%ebx
8010779e:	74 29                	je     801077c9 <dequeue+0x39>
    if (isEmpty(queue)) // empty queue
        return NULL;
    queue->front = (queue->front + 1) % (NPROC + 1);
801077a0:	83 c3 01             	add    $0x1,%ebx
801077a3:	ba 7f e0 07 7e       	mov    $0x7e07e07f,%edx
    queue->count--;
801077a8:	83 69 08 01          	subl   $0x1,0x8(%ecx)
    queue->front = (queue->front + 1) % (NPROC + 1);
801077ac:	89 d8                	mov    %ebx,%eax
801077ae:	f7 ea                	imul   %edx
801077b0:	89 d8                	mov    %ebx,%eax
801077b2:	c1 f8 1f             	sar    $0x1f,%eax
801077b5:	c1 fa 05             	sar    $0x5,%edx
801077b8:	29 c2                	sub    %eax,%edx
801077ba:	89 d0                	mov    %edx,%eax
801077bc:	c1 e0 06             	shl    $0x6,%eax
801077bf:	01 d0                	add    %edx,%eax
801077c1:	29 c3                	sub    %eax,%ebx
801077c3:	89 19                	mov    %ebx,(%ecx)
...
801077c5:	8b 44 99 0c          	mov    0xc(%ecx,%ebx,4),%eax
801077c9:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801077cc:	c9                   	leave  
801077cd:	c3                   	ret    
